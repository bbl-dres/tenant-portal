...
Usage:
    python scripts/research/convert_docs.py
    python scripts/research/convert_docs.py --dry-run
    python scripts/research/convert_docs.py --source <dir> --output <dir>
    python scripts/research/convert_docs.py --force          # re-convert existing outputs
