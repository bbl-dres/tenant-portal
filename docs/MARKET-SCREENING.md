...
|---|---|---|---|---|---|---|
| [Planon Universe + RE Mgmt for SAP S/4HANA](https://planonsoftware.com/) | Nijmegen, NL (Schneider Electric majority) | Cloud / private | Per module + named user; quote-based | SAP S/4HANA Endorsed App; BTP; IFC/BIM | Only SAP-endorsed RE/FM partner since May 2023 | **9** — Only SAP RE-FX-endorsed option; natural Buy candidate |
| [Eptura Workplace / Archibus / Serraview](https://eptura.com/) | Atlanta, USA | Cloud | Quote-based | Microsoft 365, Google, Slack, SAP | Leader in Gartner WEX MQ 2026 and Verdantix Green Quadrant 2025 | **5** — Workplace leader, no SAP RE-FX, US-hosted |
| [IBM TRIRIGA](https://www.ibm.com/products/tririga) | Armonk, USA | Cloud / on-prem | Per authorized/concurrent user | Maximo, Watson, Envizi (ESG) | Verdantix Leader 2025 | **5** — Enterprise IWMS; no SAP RE-FX path |
| [MRI Software](https://www.mrisoftware.com/) | Solon (Ohio), USA | Cloud | Per door / per unit | SAP, AppFolio Connect, GoCardless | 53 acquisitions; ANZ via Proptech Labs | **5** — Multifamily-heavy; weak federal-CH fit |
| [Nuvolo Connected Workplace](https://www.nuvolo.com/) | Paramus (NJ), USA | ServiceNow Now Platform | Named user + per asset | ServiceNow, SAP | Native ServiceNow; life-sciences strength | **2** — ServiceNow-bound; outside BBL/BIT stack |
| [Spacewell Workplace](https://spacewell.com/) (Dexma, MCS) | Antwerp, BE (Nemetschek) | Cloud | Concurrent user + IoT sensor count | BIM, IFC, Nemetschek | BIM-native IWMS; WiredScore accredited; Verdantix Leader 2025 | **5** — EU/DACH-anchored; BIM-native; no SAP RE-FX endorsement |
| [Tango](https://tangoanalytics.com/) (incl. Locatee) | Dallas, USA | Cloud | Quote-based | SAP, Yardi, Workday | Acquired Locatee Mar 2024 | **2** — US-anchored despite Locatee/Zurich |
| [FM:Systems](https://fmsystems.com/) (Johnson Controls) | Raleigh (NC), USA | Cloud | Per building / per m² | OpenBlue, BIM | Johnson Controls integration for OT/IT | **2** — US, OT-heavy; tangential to pilot |
| [Accruent (Lucernex, Famis)](https://www.accruent.com/) | Austin, USA | Cloud / hybrid | Per user + per asset | SAP, Oracle | Strong on lease admin | **2** — Lease-admin focus; not tenant-portal-shaped |
| [Trimble Manhattan ONE](https://manhattanone.trimble.com/) | Westminster (CO), USA | Cloud / on-prem | Per concurrent user | Trimble AEC | Long-standing IWMS | **2** — US generic IWMS; no federal-CH track |
| [ServiceNow WSD](https://www.servicenow.com/products/workplace-service-delivery.html) | Santa Clara, USA | ServiceNow cloud | Pro / Enterprise tiers | Now Platform, Microsoft 365, MappedIn, BMS | Visitor, case, reservation, indoor mapping, AI via Now Assist | **5** — Strong workflow/case engine; ServiceNow-bound |
...
|---|---|---|---|---|---|---|
| [Eptura Engage (ex-Condeco) / Workplace](https://eptura.com/) | Atlanta, USA | SaaS | Per user / per resource | Microsoft 365, Teams, BMS | Gartner WEX Leader 2026 | **5** — Workplace leader; not federal-residential pilot |
| [Robin](https://robinpowered.com/) | Boston, USA | SaaS | Per user; transparent tiers | Microsoft 365, Google, Slack, SCIM | Inaugural Gartner WEX Leader 2026 | **5** — Workplace leader; not pilot |
| [Appspace](https://www.appspace.com/) | Tampa, USA | SaaS | Per user / per device | Microsoft 365, ServiceNow | Signage + comms + workplace; Gartner WEX Leader 2026 | **5** — Workplace leader; comms-focused |
| [HqO](https://www.hqo.com/) (Office App) | Boston, USA / Amsterdam | SaaS | Per building / per sq ft | BMS | Acquired Office App Oct 2021 | **5** — Landlord-side workplace; not federal |
| [Equiem](https://www.getequiem.com/) | Melbourne, AU | SaaS | Per building | Office365, payment APIs | Landlord-side WEX | **2** — AU landlord-side |
| [Spaceflow](https://spaceflow.io/) | Prague, CZ | SaaS | Per building | Microsoft 365, BMS | European tenant-experience focus | **5** — EU workplace; relevant for future Buy |
| [Chainels](https://www.chainels.com/) | Rotterdam, NL | SaaS | Per building | Microsoft 365, payments | Community-led | **2** — Community-portal; off-target |
| [OfficeSpace Software](https://www.officespacesoftware.com/) | Atlanta, USA | SaaS | Per user | Microsoft 365, Google | Gartner WEX 2026 | **2** — US workplace |
| [Modo Labs](https://www.modolabs.com/) | Cambridge (MA), USA | SaaS | Per user | Microsoft 365 | MIT-spinout campus app | **2** — US campus app |
| [CXApp / CXAI](https://www.cxapp.com/) | San Francisco, USA | SaaS | Per user | Cisco Spaces, BMS | Gartner WEX 2026 | **2** — US workplace |
| [Microsoft Places](https://www.microsoft.com/microsoft-365/places) | Redmond, USA | M365 cloud | Bundled in M365 / EMS | Teams, Outlook, Viva | Tight M365 binding | **5** — M365-native; federal already has M365 |
| [Zoom Workplace](https://www.zoom.com/en/products/workspace-reservation/) | San Jose, USA | Zoom cloud | Per host / per room | Zoom Rooms, Microsoft 365 | Booking + UC | **2** — UC-bound |
| [Cohesion](https://cohesionib.com/) | Chicago, USA | SaaS | Per square foot | BMS, BACnet, IoT | Smart-building-native | **2** — US smart-building |
...
| Product | HQ / country | Hosting | Pricing | Integrations | Notable feature | BBL fit |
|---|---|---|---|---|---|---|
| [Robin](https://robinpowered.com/) | Boston, USA | SaaS | Public tiers | Microsoft 365, Google, Slack | Workplace + booking | **5** — Workplace booking; not pilot |
| [Skedda](https://www.skedda.com/) | Sydney, AU | SaaS | Per space; transparent | Microsoft 365, Google, SSO | Sports / coworking heritage | **2** — Workplace booking; SMB heritage |
| [OfficeRnD Hybrid](https://www.officernd.com/) | Sofia, BG | SaaS | Per user | Microsoft 365 | Coworking + hybrid | **2** — Coworking |
| [deskbird](https://www.deskbird.com/) | St. Gallen, CH | SaaS | Per user | Microsoft 365, Slack | DACH/CH-domiciled | **5** — Swiss-domiciled but workplace, not pilot fit |
| [Tactic](https://gettactic.com/) | New York, USA | SaaS | Per user | Microsoft 365 | Lightweight booking | **2** — US lightweight |
| [Joan (Visionect)](https://getjoan.com/) | Ljubljana, SI | SaaS + ePaper | Per device / user | Microsoft 365, Google | ePaper meeting-room displays | **2** — ePaper niche |
| [Matrix Booking](https://matrixbooking.com/) | Reading, UK | SaaS | Per user | Microsoft 365 | UK public-sector heritage | **5** — UK public-sector precedent |
| [Tribeloo](https://www.tribeloo.com/) | Brussels, BE | SaaS | Per user | Microsoft 365 | EU-anchored | **2** — EU workplace |
| [YArooms](https://www.yarooms.com/) | Bucharest, RO | SaaS | Per user | Microsoft 365, Google | EU pricing transparency | **2** — EU workplace |
| [Sharvy](https://www.sharvy.com/) | Montpellier, FR | SaaS | Per user | Microsoft 365 | Parking management strength | **2** — Parking focus |
| [Eptura Engage (Condeco)](https://eptura.com/) | Atlanta, USA | SaaS | Per user | Microsoft 365 | Long-running enterprise scheduler | **5** — Enterprise scheduler; workplace |
...
|---|---|---|---|---|
| [Envoy](https://envoy.com/) | San Francisco, USA | Per location | Visitor + desks + deliveries | **2** — US workplace visitor mgmt |
| [Proxyclick / Eptura Visitor](https://eptura.com/) | Brussels, BE / Atlanta | Per location | GDPR-native; folded into Eptura | **2** — Workplace; GDPR-native |
| [SwipedOn](https://www.swipedon.com/) | Tauranga, NZ | Per location | Tablet check-in | **2** — NZ tablet check-in |
| [Robin Visitors](https://robinpowered.com/) | Boston, USA | Per location | Integrated with Robin | **2** — Workplace add-on |
| [Kisi](https://www.getkisi.com/) | Brooklyn (NY), USA / Stockholm | Per door | Mobile access | **2** — Mobile access; workplace |
| [Verkada Guest](https://www.verkada.com/) | San Mateo, USA | Per location | Camera + access | **2** — US camera + access |
| [HID Origo](https://www.hidglobal.com/origo) | Austin, USA | Per credential | Mobile credentials | **5** — Federal-grade credentials; OT-adjacent |
| [Salto KS](https://saltoks.com/) | Oiartzun, ES | Per door | DACH installer network | **5** — DACH installer network |
| [Brivo](https://www.brivo.com/) | Bethesda, USA | Per door | Cloud access control | **2** — US cloud access |
| [dormakaba exivo](https://www.dormakaba.com/) | Rümlang, CH | Per door | Swiss-HQ; Aareon Connect partner | **9** — Swiss-HQ; KBOB-aligned; likely already in BBL buildings |
...
|---|---|---|---|---|---|---|
| [Aareon Wodis Yuneo](https://www.aareon.de/Wodis-Yuneo.970622.html) | Mainz, DE | Cloud SaaS | Per administered unit | Aareon Connect; Blue Eagle for SAP customers | DE housing market leader | **9** — DACH leader; Blue Eagle SAP RE-FX bridge |
| [Aareon RELion](https://www.aareon.de/) | Mainz, DE | Cloud / hybrid | Per unit | Aareon Connect | Commercial/mixed portfolios | **9** — Commercial RE leader; relevant for federal portfolio |
| [Aareon Smart World / Mareon](https://www.aareon.de/) | Mainz, DE | Cloud | Per unit | Aareon Connect | Embedded CRM-Mieterportal | **9** — Embedded Mieterportal pattern; Aareon ecosystem |
| [Aareon Blue Eagle (SAP IS-RE add-on)](https://www.aareon.de/) | Mainz, DE | SAP-hosted / hybrid | Quote | Native SAP IS-RE / RE-FX add-on | Direct SAP-side integration | **9** — Direct SAP RE-FX add-on; closest fit to BBL's SAP core |
| [Karthago (UTS)](https://www.aareon.de/KARTHAGO.970673.html) | DE | Hybrid | Per unit | Aareon Connect | WEG + Miet | **5** — DACH residential; WEG-focused |
| [immoware24](https://www.immoware24.de/) | Halle, DE | Cloud SaaS | Per unit | API | Cloud-native German PM; FCR Immobilien shareholder since 26 Mar 2025 | **5** — German cloud PM; no federal-CH track |
| [Haufe axera](https://www.haufe.com/) | Freiburg, DE | Cloud SaaS | Per unit | GoBD-certified | German cloud PM | **5** — German cloud PM; no federal-CH track |
| [DOMUS Software](https://www.domus-software.de/) | Aschheim, DE | Hybrid | Per unit | Open API | Long-standing DACH PM | **5** — DACH PM; some CH reach |
| [CREM SOLUTIONS iX-Haus](https://www.crem-solutions.de/) | Ratingen, DE | On-prem / hybrid | Per user | SAP, BMS | Commercial RE strength | **5** — Commercial RE; SAP integration |
| [Yardi Voyager + RentCafe](https://www.yardi.com/) | Santa Barbara, USA | Cloud / private | Per unit | Open APIs | US multifamily with strong EMEA | **5** — Multifamily; some CH presence |
| [MRI Software](https://www.mrisoftware.com/) | Solon (OH), USA | Cloud | Per unit | SAP, Workday | Capita One UK; Anacle APAC; Proptech Labs ANZ | **5** — Multifamily; weak federal-CH fit |
| [AppFolio](https://www.appfolio.com/) | Santa Barbara, USA | Cloud | Per unit + base | API | US SMB multifamily | **2** — US SMB multifamily |
| [Buildium (RealPage)](https://www.buildium.com/) | Boston, USA | Cloud | Tiered + per unit | RealPage suite | SMB multifamily | **2** — US SMB multifamily |
| [RealPage](https://www.realpage.com/) | Richardson (TX), USA | Cloud | Per unit | Open API | Multifamily | **2** — US multifamily |
| [Entrata](https://www.entrata.com/) | Lehi (UT), USA | Cloud | Per unit | Open API | US multifamily | **2** — US multifamily |
| [GARAIO REM + aroov](https://www.garaio-rem.ch/) | Bern, CH | Cloud (CH) | Per unit | Abacus, Navision, Odoo, SAP, SAP S/4HANA | Per Digital Real Estate Summit 2025 (digitalrealestate.ch): "Heute werden mit den Lösungen des PropTech Unternehmens mehr als 1.6 Millionen Mietobjekte verwaltet"; aroov is a JV with Swiss Mobiliar | **9** — Swiss-domiciled; SAP S/4HANA; CH market leader |
| [W&W ImmoTop2 / Rimo R5](https://www.wwimmo.ch/) | Affoltern am Albis, CH | Cloud / on-prem | Per user | Open interfaces | CH leader for property managers (>4,000 customers); Rimo R5 supports DE/FR/IT | **9** — Swiss-domiciled CH leader; DE/FR/IT support |
| [Abacus AbaImmo](https://www.abacus.ch/) | Wittenbach, CH | Hybrid | Per module | Abacus FIBU/CRM | Swiss ERP suite; CHF 1.5 m minority stake in Tayo (since 2021) for tenant portal | **9** — Swiss ERP; wide federal/cantonal presence |
| [Fairwalter](https://www.fairwalter.com/) | Zurich, CH (W&W subsidiary) | Azure CH | Per unit; transparent | Banking APIs | Hosted on Microsoft Azure in Switzerland | **9** — Swiss-domiciled; Azure CH residency |
| [Immomig](https://www.immomig.ch/) | Sursee/Fribourg, CH (founded 2004 by Patrick Maillard) | Cloud (CH) | Per agent | DigiRENT, dreamo.ch | AI all-in-one real-estate CRM; >6,000 users | **5** — Swiss CRM-leaning; not tenant-portal-shaped |
| [Tayo](https://www.tayo.ch/) | Lausanne, CH | Cloud (CH) | Per unit | Open API; banking | **Swiss-domiciled** tenant-portal SaaS; Abacus CHF 1.5 m minority stake since 2021 (also referenced under Abacus row) | **9** — Swiss-domiciled native tenant-portal SaaS |
| [Arthur Online](https://www.arthuronline.co.uk/) | London, UK (Aareon) | SaaS | Per unit | Aareon ecosystem | UK SMB property | **2** — UK SMB |
| [Momentum (Aareon)](https://www.momentum.se/) | Stockholm, SE (Aareon) | SaaS | Per unit | Nordic banking | Aareon Nordic platform | **2** — Nordic; weak federal-CH fit |
| [iX-Haus plus](https://www.crem-solutions.de) | Ratingen, DE (CREM Solutions) | Cloud (browser front-end) | Per user | iX-Haus core | Browser front-end above iX-Haus; AI-OCR | **5** — Commercial RE; browser front-end |
| [Haufe Real Estate Cloud](https://www.haufe.com) | Freiburg, DE (Haufe Group) | Cloud | Per unit | Open API | SaaS evolution of Haufe-Lexware Real Estate | **5** — SaaS PM; German |
| [Real4M](https://www.real4m.com) | DACH | Cloud | Per unit | Open API | PM SaaS for institutional residential | **5** — DACH institutional |
| [Solyp](https://www.solyp.com) | DACH | Cloud | Per unit | Open API | ERP for portfolio property managers | **5** — DACH portfolio managers |
| [connectedcare](https://www.connectedcare.de) | DE | Cloud | Per unit | Open API | Specialist for healthcare / senior-housing | **2** — Niche (healthcare/senior housing) |
...
|---|---|---|---|---|---|
| [casavi](https://casavi.com/) | Munich, DE | Cloud SaaS (GDPR) | Per unit; modular | >1,600 customers in DACH; Aareon Connect (Sigma, Yuneo), DOMUS, ImPower | **9** — DACH leader; Aareon ecosystem; many CH refs |
| [facilioo](https://www.facilioo.de/) | Berlin, DE | Cloud SaaS | Per unit | Aareon Connect; ista partnership | **9** — DACH tenant app; Aareon Connect |
| [Allthings](https://allthings.me/) | Basel, CH (ETH Zurich spin-off 2013) | Cloud | Per unit; modular | "App store for buildings"; >200 European RE clients; open API/SDK; ERPs incl. Wodis/Yuneo, SAP | **9** — Swiss-HQ (ETH); open SDK; SAP integration |
| [wohnungshelden](https://www.wohnungshelden.de/) | Munich, DE (Aareon) | Cloud | Per unit | Rental application + matching | **5** — Rental matching; Aareon |
| [Immomio](https://immomio.com/) | Hamburg, DE | Cloud | Per unit | Aareon Connect (Sigma/Yuneo/Immotion); digital rental | **5** — DE digital-rental focus |
| [iDWELL](https://www.idwell.com/) | Vienna, AT | Cloud | Per unit | Aareon Connect; AT tenant app | **5** — AT tenant app |
| [Spiri.Bo](https://www.spiribo.com/) | DE | Cloud | Per unit | Aareon Connect partner | **5** — DE; smaller scale |
| [etg24](https://www.etg24.de/) | Hamburg, DE | Cloud | Per unit | Aareon Connect; WEG focus | **2** — WEG-focus (DE condo law) — not federal-CH |
| [EverReal](https://everreal.co/) | Munich, DE | Cloud | Per unit | Aareon Connect; lettings + tenant lifecycle | **5** — DE lettings |
| [Yardi RentCafe Resident](https://www.yardi.com/) | Santa Barbara, USA | Cloud | Per unit | Voyager-integrated | **2** — US multifamily |
| [Bilt Rewards](https://www.biltrewards.com/) | New York, USA | Cloud | Free to tenants; landlord fees | Rent-as-loyalty; US-only | **0** — US consumer loyalty |
| [Livly](https://www.livly.io/) | Chicago, USA | Cloud | Per unit | RealPage / Yardi | **2** — US multifamily |
| [emonitor](https://www.emonitor.ch) | Zurich, CH | Cloud (CH) | Per unit | **Swiss-domiciled** residential leasing process platform; popular with CH institutional landlords | **9** — Swiss-domiciled; CH institutional refs |
| [HoldOn](https://www.holdon.ch) | CH | Cloud (CH) | Per unit | Tenant document handover and onboarding | **5** — Swiss; document-handover specialist |
| [Liobit](https://www.liobit.de) | DE | Cloud (DE) | Per unit | Tenant-side mobile app | **2** — DE small scale |
| [KIWI.KI](https://kiwi.ki) | Berlin, DE | Cloud + hardware | Per unit + hardware | Keyless access for residential building common doors; widely deployed in DE multifamily | **5** — Common-door access — adjacent |
| [propster](https://www.propster.com) | Vienna, AT | Cloud | Per unit | Buyer self-customisation portal during construction; bridges to Segment W (BIM/CDE) | **5** — Pre-occupancy / buyer customisation |
| [swarm.it](https://swarm.it) | AT | Cloud | Per unit | Resident community + service-marketplace | **2** — Community/marketplace — out of scope |
...
| Product | HQ | Pricing | Notable feature | BBL fit |
|---|---|---|---|---|
| [Fixflo](https://www.fixflo.com/) | London, UK (Aareon) | Per unit | UK repairs reporting standard | **5** — UK repairs standard; Roadmap Case A relevant |
| [Plentific](https://www.plentific.com/) | London, UK | Per unit + per work-order | UK social housing dispatch; Aareon Connect partner | **5** — UK social housing; Aareon Connect |
| [Yarowa](https://www.yarowa.com/) | Zug, CH (Metallstrasse 9, 6300 Zug — not Lucerne) | Per transaction | Founded May 2017 (Akeret, Kagi); CHF 12.4 m Series A Jul 2022 led by Eos Venture; subsidiaries Munich, London, Milan | **9** — Swiss-domiciled; relevant for Roadmap Case A |
| [Aareon Mareon](https://www.aareon.de/) | Mainz, DE | Per unit | Embedded in Aareon | **9** — Embedded in Aareon ecosystem |
| [PlanRadar](https://www.planradar.com/) | Vienna, AT | Per user | Defect / snagging / inspections; widely used in CH | **9** — Widely used in CH for defect management |
| [MaintainX](https://www.getmaintainx.com/) | Raleigh (NC), USA | Per user | Mobile-first CMMS | **2** — US mobile CMMS |
| [UpKeep](https://www.upkeep.com/) | Los Angeles, USA | Per user | Mobile CMMS | **2** — US mobile CMMS |
| [imofix.io](https://imofix.io/) | CH/DE | Per unit | GARAIO REM partner | **5** — GARAIO REM partner; CH/DE |
| [Aareon Service Cloud / casavi Mareon-Connect](https://www.aareon.com) | Mainz / Munich, DE | Per unit | Damage workflow inside Aareon ecosystem | **5** — Aareon ecosystem damage workflow |
| [Repairnet](https://www.repairnet.de) | DE | Per unit | DE damage marketplace | **2** — DE damage marketplace |
| [comgest](https://www.comgest.de) | DE | Per unit | Specialist Schadensmanagement | **2** — DE specialist |
| [Kayoom](https://www.kayoom.com) | DE | Per unit | Damage-ticket orchestration | **2** — DE niche |
...
|---|---|---|---|
| [W&W Abnahme-App](https://www.wwimmo.ch/) | Affoltern am Albis, CH | Integrated to Rimo R5 / ImmoTop2 | **9** — Swiss; integrated to CH leader Rimo R5 |
| [GARAIO REM Digitales Abnahmeprotokoll (DAP)](https://www.garaio-rem.ch/) | Bern, CH | Mobile handovers; integrated to REM | **9** — Swiss; integrated to GARAIO REM |
| [Properly](https://getproperly.com/) | Vancouver, CA | Inspection workflows | **2** — CA inspection workflow |
| [Inspectify](https://www.inspectify.com/) | Charlotte (NC), USA | Move-in inspections | **2** — US move-in inspections |
| [Allthings inspection module](https://allthings.me/) | Basel, CH | Native to Allthings tenant app | **9** — Swiss-HQ (Basel); part of Allthings |
| [HouseView](https://www.houseview.io/) | Various | 3D capture for inspections | **2** — 3D capture; niche |
| [handover.de](https://www.handover.de) | DE | Mobile-first apartment-handover protocols | **2** — DE small scale |
| [Inspizio](https://www.inspizio.ch) | CH | **Swiss-domiciled** handover protocols with photographic evidence | **9** — Swiss-domiciled; photo-evidence handovers |
...
| Product | HQ | Notable feature | BBL fit |
|---|---|---|---|
| [Skribble](https://www.skribble.com/) | Zurich, CH (Förrlibuckstrasse 190); office in Karlsruhe, DE | QES compliant with Swiss ZertES and EU eIDAS; partner of Swisscom Trust Services and ELCA trustID; per Skribble press release (skribble.com, 1 Sep 2022): the €10 m Series A was "led by Acton Capital Partners GmbH from Munich… VI Partners AG, from Altendorf, Switzerland, is on board as co-lead"; ISO 27001 | **9** — Swiss QES leader; ZertES + eIDAS |
| [SwissSign / SwissID](https://www.swisssign.com/) | Glattbrugg, CH | Swiss Post-owned identity and trust service | **9** — Swiss Post identity / trust service |
| [AGOV](https://www.agov.admin.ch/) | Bundeskanzlei DTI, Bern | Federal login (CH-LOGIN successor) for federal, cantonal, communal authorities; passwordless via AGOV access App or hardware security key; **1.6 m residents with AGOV accounts and 8 m logins in 2025**; SAML/OIDC IdP; operated by FOITT | **9** — Target login for public tenants (OP-3) |
| [Swiss e-ID](https://www.eid.admin.ch/) | EJPD / Bundeskanzlei | State-issued, SSI-based; planned launch **1 December 2026**; usable as login factor in AGOV | **9** — Federal e-ID — future state from Dec 2026 |
| [eIAM / sign.eIAM](https://www.eiam.admin.ch/) | FOITT, CH | Federal IAM for **internal/staff access** to federal-administration systems. **AGOV replaces CH-LOGIN for public users**; eIAM remains in service for federal staff — the two are co-existent, not predecessor/successor | **9** — Pilot login provider (NFA-IAM-001 Must) |
| [DocuSign](https://www.docusign.com/) | San Francisco, USA | Largest international e-signature provider | **5** — International alt; not on Swiss federal trust list |
| [Adobe Sign / Acrobat Sign](https://www.adobe.com/sign.html) | San José, USA | Tightly integrated to Adobe ID | **5** — International alt; Adobe-ID-bound |
| [Yousign](https://yousign.com/) | Caen, FR | eIDAS-compliant EU vendor | **5** — EU eIDAS alternative |
| [Scrive](https://www.scrive.com/) | Stockholm, SE | Aareon Connect partner for digital signatures | **5** — Nordic; Aareon Connect partner |
...
| Product | HQ | Hosting | Pricing | Notable feature | BBL fit |
|---|---|---|---|---|---|
| [Acta Nova (RUBICON IT)](https://www.rubicon.eu/en/products/acta-nova/) | Vienna, AT (CH-Vertrieb via RUBICON CH) | On-prem + Swiss federal data centre (ISCeco operated) | Per-seat licence + ops | **Dominant CH federal GEVER**: 26,000+ federal employees since August 2021; integrator Atos Switzerland; GENOVA programme investment CHF 142 m per SFAO audit. Also at SBB, VBZ, 900+ Swiss municipalities | **9** — Federal-CH standard GEVER; relevant for archive (NFA-DATA-002) |
| [Fabasoft eGov-Suite](https://www.fabasoft.com/en/on-egov/egov-suite) | Linz, AT | Fabasoft PROCECO Cloud (CH/DE/AT regions) | Per-seat | DE "E-Akte Bund" rollout in 200+ federal authorities since 2017 contract; AT ELAK since 2004; CH variant supports GEVER; ISO 27001, BSI C5, first-global EU Cloud Code of Conduct Level 3 (2021) | **5** — Strong federal-DE track; AT-HQ |
| [OneGov GEVER (Fabasoft 4teamwork)](https://www.fabasoft.com/en/on-proceco/onegov-gever) | Bern, CH (4teamwork — part of Fabasoft Group since 2022) | Fabasoft PROCECO Cloud (Swiss data location) | Per-seat | "swiss made software"; deployed in Cantons Aargau, St. Gallen, Zug + many municipalities; cloud-native rebuild on PROCECO ecosystem launched 2024 | **9** — Swiss-domiciled; cantonal GEVER references |
| [CMI Konsul](https://www.cmiag.ch) | Zug, CH (CMI AG) | On-prem + CH cloud | Per-seat | Swiss-cantonal GEVER + Schul-CMI; predecessor to Acta Nova in some federal offices | **5** — Swiss-HQ; cantonal focus |
| [Axioma (Glaux Soft)](https://www.glauxsoft.com) | Bern, CH | On-prem / CH cloud | Per-seat | Swiss-domiciled records & workflow product line | **5** — Swiss-domiciled records/workflow |
| [iLM (KS-Software / Kanzleisoft)](https://www.ks-software.ch) | CH | On-prem / cloud | Per-seat | Swiss municipal/Kanton dossier mgmt | **5** — Swiss municipal dossier mgmt |
| [d.velop documents (d.3ecm)](https://www.d-velop.com) | Gescher, DE | On-prem + d.velop cloud | Per-user | DE ECM mid-market leader | **2** — DE mid-market ECM |
| [DocuWare](https://www.docuware.com) | Germering, DE (acq. by Ricoh 2019) | Cloud + on-prem | Per-user / per-document | DACH-strong DMS in SME/Hausverwaltung | **2** — DACH SME DMS |
| [ELO ECM](https://www.elo.com) | Stuttgart, DE | On-prem + ELO Business Cloud | Per-user | DACH ECM; KGSt and IVV references | **2** — DACH ECM |
| [OpenText Content Suite / Extended ECM](https://www.opentext.com) | Waterloo, CA | On-prem + OpenText Cloud | Per-user | Enterprise ECM; SAP-integrated archive | **5** — Enterprise ECM with SAP archive |
| [M-Files](https://www.m-files.com) | Tampere, FI | Cloud + on-prem | Per-user | Metadata-driven DMS | **2** — FI metadata DMS |
| [nscale (Ceyoniq → Kyocera)](https://www.kyocera.com/de) | Bielefeld, DE | On-prem | Per-user | German public-sector ECM | **5** — DE federal track |
| [Aareon Archiv kompakt / DMS](https://www.aareon.com) | Mainz, DE | Cloud | Bundled with Aareon ERP | DMS bundled with Aareon RELion/Wodis | **5** — Bundled with Aareon ERP |
| [SharePoint Online (Microsoft 365)](https://www.microsoft.com/microsoft-365) | Redmond, US (CH residency available via Swiss DCs) | Microsoft Cloud (CH/EU) | Per-user M365 | Federal alignment depends on tenant-residency configuration | **5** — M365-native; CH residency configurable |
...
| Product | HQ | Hosting | Pricing | Notable feature | BBL fit |
|---|---|---|---|---|---|
| [Parloa](https://www.parloa.com) | Berlin, DE (offices Munich, NY, San Francisco) | Cloud (DE/EU) | Enterprise quote | "Agent Management Platform"; €310 m Series D January 2026 at $3 b valuation (EU-Startups); employing **more than 380 people at time of Series D close (January 2026)** per Silicon Republic, with publicly stated plan to grow headcount to 600 by end of 2026; ISO 27001 / SOC 2 / GDPR / HIPAA / DORA; customers incl. Swiss Life, Allianz, SAP, Booking.com, TeamViewer | **5** — European leader; CH refs via Swiss Life |
| [Cognigy](https://www.cognigy.com) | Düsseldorf, DE | Cloud (DE/EU) | Enterprise quote | **Acquired by NICE end of 2025** per Startup-in-Europe (Jan 2026); enterprise conversational AI; agentic-AI platform | **5** — EU enterprise conversational AI |
| [PolyAI](https://poly.ai) | London, UK | Cloud (UK/EU/US) | Per-minute | Voice-first enterprise; €73.2 m Series D 2025 | **2** — UK voice-first enterprise |
| [moin AI](https://www.moin.ai) | Hamburg, DE | Cloud (DE) | Subscription | DE customer-service chatbot | **2** — DE chatbot |
| [Synthflow](https://synthflow.ai) | Berlin, DE | Cloud | Per-minute | Voice agent platform | **2** — DE voice agent |
| [Vapi](https://vapi.ai) | San Francisco, US (Y Combinator) | Cloud | Per-minute | Developer voice-agent infra | **2** — US dev infra |
| [Bland](https://www.bland.ai) | San Francisco, US | Cloud | Per-minute | Voice agent infra | **2** — US voice infra |
| [Aareon CRM-Portal AI / Allthings AI](https://www.aareon.com) | Mainz, DE | Cloud | Bundled with Aareon ERP | Tenant CRM with embedded chat; Aareon's TPG-CDPQ ownership since closing in H2 2024 (transaction enterprise value €3.9 b per TPG press release of 24 June 2024) | **5** — Aareon-bundled; DACH residential |
| [casavi smartflows](https://casavi.com/en) | Munich, DE (Aareon subsidiary) | Cloud (DE) | Add-on subscription | Workflow automation with LLM triage; integrated with Hausverwalter-Software | **5** — Aareon ecosystem; LLM-triage |
| [Knock](https://www.knockcrm.com) | Seattle, US | Cloud (US) | Per-unit | US multifamily lead-management AI | **2** — US multifamily |
| [RentDynamics](https://rentdynamics.com) | Lehi, US | Cloud (US) | Per-unit | US multifamily contact-centre AI | **2** — US multifamily |
| [Lobby](https://www.lobby.io) | UK | Cloud | Subscription | UK BTR resident assistant | **2** — UK BTR |
| [Famulor](https://famulor.io) | EU | Cloud | Per-minute | EU voice-agent for property/SME | **2** — EU SME voice agent |
| [AskHive.ai](https://www.askhive.ai) | UK | Cloud | Subscription | UK property voice agents | **2** — UK property |
| [Renty](https://renty.ai) | DE | Cloud (DE) | Subscription | German Hausverwaltung AI | **2** — DE Hausverwaltung AI |
| [Lassie](https://lassie.com) | Stockholm, SE | Cloud (EU) | Per-property | Nordic property assistant | **2** — Nordic property |
| [Microsoft Copilot for M365](https://www.microsoft.com/microsoft-365/copilot) | Redmond, US (Swiss region available) | Microsoft Cloud (CH/EU) | M365 add-on per-user | Federal-relevant if M365 tenant is in CH regions | **5** — M365-native; federal already has M365 |
| [Anthropic Claude via Swisscom Sovereign Cloud](https://trustservices.swisscom.com) | San Francisco, US (Anthropic) hosted in Swisscom CH DCs | Swisscom Sovereign Swiss AI Platform (CH) | Per-token; Swisscom packaging | Swiss-hosted enterprise LLM access | **9** — Swiss-hosted enterprise LLM |
| [Apertus (Swiss AI Initiative)](https://www.swiss-ai.org/apertus) | EPFL Lausanne + ETH Zurich + CSCS Lugano | CSCS "Alps" supercomputer + Swisscom Sovereign Swiss AI Platform | Open-source (Apache 2.0); compute paid | **Switzerland's first large-scale, open, multilingual LLM, released 2 September 2025; 8 B and 70 B parameters; trained on 15 trillion tokens covering 1,000+ languages incl. Swiss German and Romansh; ~40 % non-English data (ETH Zurich press release)** | **9** — Swiss sovereign LLM; CH-multilingual; EMBAG-aligned |
| [BärnBot (Stadt Bern Chatbot)](https://www.bern.ch) | Bern, CH (city admin) | Cloud (CH) | City budget | Reference e-gov chatbot in CH | **5** — CH e-gov reference; municipal scale |
| [Lina (Stadt Zürich Chatbot)](https://www.stadt-zuerich.ch) | Zurich, CH | Cloud (CH) | City budget | Zurich city chatbot reference | **5** — CH e-gov reference; municipal scale |
| [Swisscom Conversational AI](https://www.swisscom.ch) | Bern, CH | Swisscom Cloud (CH) | Enterprise quote | Genesys-integrated voice AI | **9** — Swisscom CH; sovereign hosting |
...
| Product | HQ | Notable feature | BBL fit |
|---|---|---|---|
| [Spacewell Cobundu](https://spacewell.com/) | Antwerp, BE | Smart-building IoT in Nemetschek group | **5** — EU IoT; Roadmap Case B |
| [Siemens Building X](https://www.siemens.com/buildingx) | Munich, DE | Buildings + grid + sustainability | **5** — DE BMS leader; Roadmap |
| [Johnson Controls OpenBlue](https://www.johnsoncontrols.com/openblue) | Cork, IE | Enterprise OT + AI | **2** — Enterprise OT |
| [Honeywell Forge](https://www.honeywell.com/) | Charlotte (NC), USA | Industrial / buildings | **2** — US industrial |
| [Cisco Spaces](https://spaces.cisco.com/) | San Jose, USA | Wi-Fi-based location intelligence | **2** — Wi-Fi location |
| [Cohesion](https://cohesionib.com/) | Chicago, USA | Smart-building + WEX | **2** — US smart-building |
| [View Smart](https://view.com/) | Milpitas (CA), USA | Smart glass + analytics | **2** — Smart-glass niche |
| [Disruptive Technologies](https://www.disruptive-technologies.com/) | Oslo, NO | Cellular IoT sensors | **2** — NO IoT sensors |
| [ThoughtWire](https://www.thoughtwire.com/) | Toronto, CA | Hospital + smart-building twin | **2** — CA hospital-focused |
| [Comfy (Siemens)](https://www.comfyapp.com/) | Oakland (CA), USA | Siemens Smart Infrastructure | **5** — Siemens-bound; workplace |
| [Schindler Ahead](https://www.schindler.com/com/internet/en/mobility-solutions/products/schindler-ahead.html) | Ebikon, CH | **Swiss-domiciled** elevator/escalator IoT (ActionBoard, RemoteMonitoring); widespread in federal buildings | **9** — Swiss-domiciled; likely already in federal buildings |
| [KONE 24/7 Connected Services](https://www.kone.ch/) | Espoo, FI (KONE; CH subsidiary Brüttisellen) | Elevator/escalator predictive-maintenance IoT; deep CH installer presence | **9** — Strong CH installer base |
| [Bosch IoT Suite](https://www.bosch-iotsuite.com/) | Stuttgart, DE | DE-anchored building/asset IoT; FIWARE-compatible | **5** — DE IoT; FIWARE-compatible |
| [BuildingMinds](https://buildingminds.com/) | Berlin, DE (Schindler family-backed) | Real-estate data platform / digital twin spanning asset, ESG and tenant data; CRREM, EU Taxonomy and EPBD modules — **cross-listed in Segment Z** | **5** — Schindler-backed; ESG + twin |
| [Akenza](https://akenza.io) | Zurich, CH | **Swiss IoT platform**; LoRaWAN-friendly low-code; sits between Segment AG (OT) and Segment L (twin) for non-HVAC smart-building telemetry | **9** — Swiss-domiciled IoT platform |
| [Locatee → Tango](https://www.tangoanalytics.com) | Zurich, CH (acquired by Tango Analytics 2024) | Workplace-utilisation analytics; CH presence retained; cross-listed in Segment V | **5** — CH-anchored despite Tango parent |
| [Pricer](https://www.pricer.com) | Stockholm, SE | Electronic shelf labels in workplace contexts | **2** — Shelf labels — off-topic |
| [Smartvatten](https://www.smartvatten.com) | Helsinki, FI | Water-leak monitoring with API to BMS | **2** — Water-leak niche |
...
| Product | HQ | Hosting | Pricing | Notable feature | BBL fit |
|---|---|---|---|---|---|
| [Visual Lease](https://visuallease.com/) | Woodbridge (NJ), US | Cloud | Per lease | IFRS 16 / ASC 842 / GASB 87 lease accounting | **2** — US lease accounting |
| [LeaseAccelerator](https://leaseaccelerator.com/) | Reston (VA), US | Cloud | Per lease | Enterprise lease accounting + workflow | **2** — US enterprise |
| [CoStar Real Estate Manager](https://www.costargroup.com/realestatemanager) | Washington, US | Cloud | Quote | CoStar-integrated portfolio + lease accounting | **2** — US portfolio |
| [Nakisa Lease Administration](https://www.nakisa.com/) | Montréal, CA | Cloud | Per lease | SAP-certified IFRS 16 / ASC 842 | **5** — SAP-certified |
| [MRI ProLease](https://www.mrisoftware.com/products/prolease/) | Solon (OH), US (MRI) | Cloud | Per lease | Within MRI ecosystem; IFRS 16 / ASC 842 | **2** — MRI ecosystem |
| [LucernEx (Accruent)](https://www.accruent.com/products/lucernex) | Austin, US (Accruent) | Cloud | Per lease | Lease admin + accounting; common in US retail / corporate | **2** — US retail/corporate |
| [UPK Online](https://www.upk-online.ch) | CH | Cloud (CH) | Subscription | Niche Swiss lease-accounting | **5** — Swiss niche |
| [SwissProperty](https://www.swissproperty.ch) | CH | Cloud (CH) | Subscription | **Swiss-domiciled** lease / portfolio accounting | **9** — Swiss-domiciled portfolio accounting |
| [RealFusio](https://www.realfusio.com) | CH / EU | Cloud | Subscription | Real-estate fund accounting | **5** — CH/EU fund accounting |
...
| Product | HQ | Notable feature | BBL fit |
|---|---|---|---|
| [Techem](https://www.techem.com/) | Eschborn, DE | Submetering + tenant heating bills | **5** — DE major, widely deployed in CH |
| [ista](https://www.ista.com/) | Essen, DE | Submetering + Mieter API | **5** — DE major, widely deployed in CH |
| [Brunata-Metrona](https://www.brunata-metrona.de/) | Hürth, DE | Submetering DACH | **5** — DACH submetering |
| [Minol](https://www.minol.com/) | Leinfelden-Echterdingen, DE | Tenant consumption portal | **5** — DACH tenant portal |
| [Aareon EnergieHub](https://www.aareon.com/) | Mainz, DE | Energy data hub for housing operators | **5** — Aareon energy hub |
| [Spacewell Energy (Dexma)](https://spacewell.com/) | Barcelona, ES | AI energy management | **5** — EU energy AI |
| [NeoVac](https://www.neovac.ch/) | Oberriet, CH | **Swiss-domiciled** submetering, heat-cost allocation and tenant cost-reporting; deep CH installer network | **9** — Swiss-domiciled; closest CH submetering choice |
| [Equa Solutions](https://www.equa-solutions.ch/) | Lausanne, CH | **Swiss-domiciled** HVAC controls + sub-metering optimisation | **9** — Swiss-domiciled HVAC+submetering |
| [CSEM Smart Energy](https://www.csem.ch) | Neuchâtel, CH | Research-driven CH smart-grid solutions | **5** — CH research-driven |
| [BKW Power Grid](https://www.bkw.ch) | Bern, CH | Utility-grade grid + smart-meter offering relevant to large-portfolio landlords | **9** — CH utility; relevant for large federal portfolios |
...
| Product | HQ | Hosting | Pricing | Notable feature | BBL fit |
|---|---|---|---|---|---|
| [ImmoScout24.ch](https://www.immoscout24.ch) | Zurich, CH (SMG Swiss Marketplace Group) | Cloud (CH) | Per-listing + premium options | CH market leader by traffic: 3.27 m monthly visits (SemRush, March 2026) | **5** — CH leader; BBL is not a listing actor |
| [Homegate.ch](https://www.homegate.ch) | Zurich, CH (SMG) | Cloud (CH) | Per-listing | 2.6 m monthly visits Mar 2026; controversy over MieterPlus subscription (CHF 39.95 with 3-month minimum, per OnlineMarketplaces Mar 2024) | **5** — CH leader; BBL is not a listing actor |
| [Flatfox.ch](https://www.flatfox.ch) | Zurich, CH (SMG) | Cloud (CH) | Free listing + paid add-ons | 1.65 m monthly visits; chat-first UX; popular for free landlord listing | **5** — CH portal; not BBL use case |
| [Comparis Immobilien](https://en.comparis.ch) | Zurich, CH | Cloud (CH) | Aggregator | 2.79 m monthly visits; aggregates other portals | **5** — CH aggregator |
| [Newhome.ch](https://www.newhome.ch) | Zurich, CH (cantonal-bank consortium) | Cloud (CH) | Per-listing | 1.23 m monthly visits; cantonal-bank-owned | **5** — CH cantonal-bank portal |
| [RealAdvisor](https://realadvisor.ch) | Zurich/Geneva, CH | Cloud (CH) | Lead-gen for agents | AVM-driven valuation + agent matching | **2** — Agent lead-gen |
| [ImmoStreet.ch / Acheter-Louer.ch / Anibis.ch / Pomona.ch](https://swissmarketplace.group/portfolio/real-estate/) | CH (SMG portfolio) | Cloud (CH) | Per-listing | SMG-portfolio long-tail CH portals | **2** — Long-tail CH portals |
| [ImmoScout24.de](https://www.immobilienscout24.de) | Berlin, DE (Scout24 SE) | Cloud (DE) | Per-listing + premium | DE market leader | **2** — DE consumer |
| [Immowelt](https://www.immowelt.de) | Nuremberg, DE (Axel Springer / Aviv) | Cloud (DE) | Per-listing | DE #2 | **2** — DE consumer |
| [Immonet](https://www.immonet.de) | Hamburg, DE (Axel Springer) | Cloud (DE) | Per-listing | DE #3, merged ops with Immowelt | **2** — DE consumer |
| [Wunderflats](https://wunderflats.com) | Berlin, DE | Cloud (DE) | Commission | Mid-term/corporate furnished housing | **2** — DE corporate housing |
| [Homelike](https://www.thehomelike.com) | Cologne, DE | Cloud (DE) | Commission | Corporate-housing platform | **2** — DE corporate |
| [Spotahome](https://www.spotahome.com) | Madrid, ES | Cloud (EU) | Commission | Mid-term rentals, video-verified | **0** — ES consumer |
| [willhaben Immobilien](https://www.willhaben.at) | Vienna, AT | Cloud (AT) | Per-listing | AT classifieds market leader | **0** — AT consumer |
| [ImmoScout24.at](https://www.immobilienscout24.at) | Vienna, AT | Cloud (AT) | Per-listing | AT real-estate leader | **0** — AT consumer |
| [Zillow](https://www.zillow.com) | Seattle, US | Cloud (US) | Premier Agent / lead | US market leader | **0** — US consumer |
| [Rightmove](https://www.rightmove.co.uk) | London, UK | Cloud (UK) | Agent subscription | UK leader | **0** — UK consumer |
| [Zoopla](https://www.zoopla.co.uk) | London, UK | Cloud (UK) | Agent subscription | UK #2 | **0** — UK consumer |
| [Idealista](https://www.idealista.com) | Madrid, ES | Cloud (EU) | Per-listing | ES/PT/IT leader | **0** — EU consumer |
| [CBRE Deal Flow](https://www.cbre.com) | Dallas, US | Cloud | Bundled with CBRE services | Commercial transaction platform | **2** — US commercial |
| [JLL OfficeFinder](https://www.us.jll.com) | Chicago, US | Cloud | Bundled | Commercial leasing | **2** — US commercial |
| [LoopNet (CoStar)](https://www.loopnet.com) | Washington, US | Cloud (US) | Subscription | US commercial leader | **2** — US commercial |
| [Crexi](https://www.crexi.com) | Los Angeles, US | Cloud (US) | Subscription | US commercial #2 | **2** — US commercial |
| [Realla (CoStar UK)](https://www.realla.co.uk) | London, UK | Cloud | Subscription | UK commercial | **2** — UK commercial |
| [savills.com](https://www.savills.com) | London, UK | Cloud | Free property search | Global broker portal | **2** — Global broker portal |
| [simap.ch](https://www.simap.ch) | Bern, CH (federal/cantonal) | Federal cloud (CH) | Free public access | **Swiss federal/cantonal procurement portal where BBL itself publishes tender notices** | **9** — Federal procurement portal — BBL already publishes here |
| [meine BImA](https://meine-bima.bundesimmobilien.de) | Bonn, DE (BImA) | Federal DE infrastructure | Free | **BImA Geschäftsbereich Wohnen tenant-facing self-service portal — relaunched 13 March 2024 with simplified login**; covers Wohnungsfürsorge des Bundes | **9** — Direct federal benchmark (DE peer to BBL pilot) |
| [Immobilienportal der BImA](https://immobilienportal.bundesimmobilien.de) | Bonn, DE (BImA) | Federal DE | Free public | BImA's full portfolio: Wohn-, Gewerbe-, Land- & Forst-, Wohnungsfürsorge | **9** — BImA full-portfolio benchmark |
...
|---|---|---|---|
| ["Mein BImA"](https://meine-bima.bundesimmobilien.de/) | BImA, Bonn, DE | Migrated 13 Mar 2024 from legacy username/password into single "meine BImA" account; Wohnungsfürsorge access, Reparaturservice (365×24×7), Immobilienportal, GESA | **9** — DE federal benchmark — direct BBL peer |
| [GSA PBS Customer Dashboard / OASIS](https://www.gsa.gov/) | US GSA, Washington DC | Federal tenant dashboard | **5** — US federal reference |
| [GPA Workplace Services Toolkit](https://www.gov.uk/government/organisations/government-property-agency) | London, UK | Government Hubs | **5** — UK federal reference |
| [Senaatti "Senate App"](https://steerpath.com/case-study-senaatti) | Senaatti-kiinteistöt, Helsinki, FI | Built by Steerpath; indoor maps + booking; Virtu ID / email login via asiointi.senaatti.fi | **5** — FI federal reference |
| [Rijksvastgoedbedrijf](https://www.rijksvastgoedbedrijf.nl/) | Dutch Central Government RE Agency, The Hague | Tenant relations in development | **5** — NL federal reference |
| [BIG Wohn- und Mieterservice](https://www.big.at/) | Bundesimmobiliengesellschaft, Vienna | Austrian federal property | **5** — AT federal reference |
| [Statsbygg](https://www.statsbygg.no/) | Oslo, NO | Norwegian state property | **5** — NO federal reference |
| [armasuisse Immo-Portal VBS](https://www.ar.admin.ch/de/immo-portal) | armasuisse Immobilien, Bern, CH | Re-launched 1 May 2024; role-based (Nutzer/Mieter/Eigentümervertreter/Betreiber/IKT/Departementsebene); ZUVA Weisungen; DE/FR (IT planned); BBL liaison for Bern Verwaltungsbauten codified | **9** — Closest CH federal peer — directly comparable |
| [Bouwinvest](https://www.bouwinvest.com/) | Amsterdam, NL | Dutch state-pension-backed RE investor; **operator benchmark** for tenant portals on a proprietary stack (not a vendor sale) | **5** — NL investor reference |
| [CBRE Investment Management](https://www.cbreim.com/) | Los Angeles, USA | Global RE investor; **operator benchmark** for corporate-occupier tenant portals on a proprietary stack | **2** — US investor reference |
| [Defence Infrastructure Organisation (DIO)](https://www.gov.uk/government/organisations/defence-infrastructure-organisation) | Sutton Coldfield, UK | UK MoD estate operator; military-housing benchmark adjacent to CH armasuisse perimeter | **5** — UK MoD; military-housing |
...
|---|---|---|---|
| [Planon RE Management for SAP S/4HANA](https://planonsoftware.com/) | Planon (NL) — SAP-endorsed | Co-engineered on SAP One Domain Model and BTP; Finance/Contract/Lease accounting on S/4HANA; RE management + Space + Workplace + Asset/Maintenance + Energy on Planon | **9** — Only SAP-endorsed RE/FM pattern |
| [Goldinmotion Simple Property Management](https://www.goldinmotion.com/) | Goldinmotion (DE) | Lightweight SAP-side add-on | **5** — Lightweight SAP add-on |
| [Promos.GT](https://www.promos-consult.de/) | Promos (DE) | SAP IS-RE specialist for housing | **5** — SAP IS-RE specialist (DE housing) |
| [Aareon SAP Blue Eagle](https://www.aareon.de/) | Aareon (DE) | Long-standing SAP-side add-on | **9** — Long-standing SAP RE-FX add-on |
| [Aareon Connect via Locoia](https://connect-docs-de.locoia.com/) | Aareon Locoia (DE) | Low-code/iPaaS connecting Wodis Yuneo, Sigma, SAP Blue Eagle, Karthago, Immomio, casavi, Plentific, EverReal, Spiri.Bo, dormakaba, KIWI | **5** — Aareon ecosystem glue |
| [Custom Fiori on SAP BTP](https://www.sap.com/products/business-technology-platform.html) | SAP BTP | Build-own; respects SAP "clean core" | **9** — EMBAG-aligned; respects SAP "clean core" |
...
|---|---|---|---|
| [Swisscom Sovereign Cloud / Enterprise Cloud](https://www.swisscom.ch/) | CH Tier-4 DCs | SAP-on-demand; Cloud Access to Azure/AWS/Google/Oracle | **9** — CH Tier-4 sovereign; SAP-on-demand |
| [Exoscale](https://www.exoscale.com/) | Zurich, Geneva, Vienna, Frankfurt, Munich, Sofia | CH-domiciled | **9** — CH-domiciled |
| [Infomaniak](https://www.infomaniak.com/) | Geneva, CH | CH-domiciled | **9** — CH-domiciled |
| AWS Europe (Zurich) — `eu-central-2` | Zurich, CH | Opened Nov 2022; 3 AZs. Per AWS press release (BusinessWire, 8 Nov 2022): "AWS is planning to invest an estimated $5.9 billion (approx. 5.9 billion Swiss francs) in Switzerland during the next 15 years." | **9** — CH region; hyperscaler data residency |
| Azure Switzerland North / Switzerland West | Zürich / Geneva | Launched 2019 | **9** — CH regions; M365-aligned |
| Google Cloud `europe-west6` (Zurich) | Zurich | Launched 2019 | **9** — CH region |
| AWS European Sovereign Cloud — `aws-eusc` (`eusc-de-east-1`, Brandenburg, DE) | Brandenburg, DE | GA 14 Jan 2026; €7.8 bn investment; EU-resident personnel/operations; NOT in Switzerland | **5** — EU sovereign — not CH |
| [Green.ch](https://www.green.ch) | Lupfig, CH | Largest Swiss data-centre operator; FINMA-grade | **9** — CH DC operator; FINMA-grade |
| [Equinix Zurich (ZH4 / ZH5)](https://www.equinix.com) | Zurich, CH | Major Swiss colocation campuses | **9** — CH colocation |
| [Aspectra](https://www.aspectra.ch) | Zurich, CH | Swiss managed-hosting and managed-cloud specialist; FINMA-grade | **9** — CH managed hosting |
| [Hetzner](https://www.hetzner.com) | Gunzenhausen, DE (Falkenstein + Helsinki DCs) | Low-cost EU hyperscaler-alternative | **2** — DE low-cost; no CH residency |
| [OVHcloud](https://www.ovhcloud.com) | Roubaix, FR (Strasbourg DC) | FR sovereign-cloud option | **5** — FR sovereign |
| [Scaleway](https://www.scaleway.com) | Paris, FR (Iliad) | FR sovereign cloud | **5** — FR sovereign |
| [T-Systems Open Telekom Cloud](https://www.t-systems.com) | Bonn, DE | DE sovereign cloud; BSI C5 | **5** — DE sovereign |
| [STACKIT](https://www.stackit.de) | Heilbronn, DE (Schwarz Gruppe / Lidl) | DE sovereign-cloud emerging player | **5** — DE sovereign |
| [IONOS Cloud](https://cloud.ionos.com) | Karlsruhe, DE | DE sovereign-cloud | **5** — DE sovereign |
| [GleSYS](https://glesys.com) | Falkenberg, SE | Nordic sovereign-cloud | **2** — Nordic |
| [Cleura](https://cleura.com) | Karlskrona, SE | Nordic sovereign-cloud | **2** — Nordic |
...
| Product | HQ | Hosting | Pricing | Notable feature | BBL fit |
|---|---|---|---|---|---|
| [SAP Integration Suite (BTP)](https://www.sap.com/products/business-technology-platform.html) | Walldorf, DE | SAP BTP (regional, incl. CH where licensed) | Per message | SAP-native; co-deployable with Custom Fiori on BTP (Segment Q) | **9** — SAP-native; aligns with Q-segment pattern |
| [MuleSoft (Salesforce)](https://www.mulesoft.com) | San Francisco, US (Salesforce) | Cloud | Per connector + capacity | Anypoint platform; widely used in DACH enterprise | **5** — Enterprise iPaaS |
| [Workato](https://www.workato.com) | Mountain View, US | Cloud | Per workspace | Enterprise iPaaS (cross-listed in Segment BB) | **5** — Enterprise iPaaS |
| [Boomi](https://boomi.com) | Conshohocken (PA), US | Cloud | Per connector | iPaaS leader; large connector library | **5** — iPaaS leader |
| [Frends](https://frends.com) | Tampere, FI | Cloud + on-prem | Per environment | Nordic iPaaS; OSS-friendly options | **9** — OSS-friendly; EMBAG-aligned |
| [Aareon Locoia](https://connect-docs-de.locoia.com/) | Mainz, DE (Aareon) | Cloud (DE) | Per workflow | Glue between Aareon Connect ecosystem: Wodis Yuneo, Sigma, SAP Blue Eagle, Karthago, Immomio, casavi, Plentific, EverReal, Spiri.Bo, dormakaba, KIWI | **5** — Aareon ecosystem glue |
...
| Product | HQ | Hosting | Pricing | Notable feature | BBL fit |
|---|---|---|---|---|---|
| [Bexio](https://www.bexio.com) | Rapperswil-Jona, CH (Swisscom subsidiary) | Cloud (CH) | CHF 45/mo Basic to CHF 129/mo Ultimate (Magic Heidi 2026) | **100,000 customers as of 19 February 2026** per bexio AG press release (CEO Markus Naef: "Today we celebrate 100,000 entrepreneurs who are advancing the digitalisation of Switzerland with us") | **5** — Swiss SME accounting; BBL is on SAP |
| [Klara](https://www.klara.ch) | Bern, CH (Swisscom-backed) | Cloud (CH) | From CHF 49/mo Business Starter | 30,000+ SMEs; AI receipt scanning; KLARA Buchhaltung integrated | **5** — Swiss SME accounting; BBL is on SAP |
| [Banana Buchhaltung](https://www.banana.ch) | Lugano, CH (Banana.ch SA, since 1988) | On-prem + iPad app | CHF 0 Free / CHF 69 Professional / CHF 149 Advanced annual | One-time purchase model; Excel-like UX; 120+ countries | **2** — SME desktop accounting |
| [Abacus AbaNinja / Abacus](https://www.abacus.ch) | Wittenbach-St. Gallen, CH | On-prem + Abacus Cloud | Per-user | CH mid-market ERP+accounting standard | **5** — CH mid-market standard |
| [Intrum AG (Inkasso-Schweiz)](https://www.intrum.ch) | Schwerzenbach, CH | Cloud | Success-fee + per-case | DACH Mahnwesen + Inkasso leader | **5** — CH Inkasso leader; federal use unlikely |
| [CRIF AG Mahnwesen](https://www.crif.ch) | Zurich, CH | Cloud | Per-case | Bonität + Inkasso bundle | **5** — CH Bonität + Inkasso |
| [Creditreform Schweiz Inkasso](https://www.creditreform.ch) | St. Gallen, CH | Cloud | Success-fee | Membership-based Inkasso | **5** — CH Inkasso |
| [EOS Schweiz](https://ch.eos-solutions.com) | Volketswil, CH (Otto Group) | Cloud | Success-fee | DACH-wide Inkasso | **2** — DACH Inkasso |
| [Inkasso Service AG](https://www.inkasso.ch) | Lucerne, CH | Cloud | Success-fee | Swiss Inkasso | **2** — Swiss Inkasso |
| [GoCardless](https://gocardless.com) | London, UK | Cloud (EU) | ~1 % + £/€ 0.20 per tx | Direct-debit (SEPA, BACS) for recurring rent | **2** — EU direct debit; not federal-CH |
| [Stripe Billing / Stripe Connect](https://stripe.com) | Dublin, IE / San Francisco, US | Cloud (EU residency) | ~2.9 % + €0.25 | Embedded payments for property managers | **2** — Embedded payments |
| [TrueLayer](https://truelayer.com) | London, UK | Cloud (EU) | Per-API call | Open-Banking PIS for rent payments | **2** — Open Banking PIS |
| [Yapily](https://www.yapily.com) | London, UK | Cloud (EU) | Per-API call | API-first Open Banking | **2** — Open Banking API |
| [Bilt Rewards](https://www.biltrewards.com) | New York, US | Cloud (US) | Free to tenants; cobranded card revenue | US rent-as-loyalty card; partnered Wells Fargo; no DACH presence | **0** — US consumer loyalty |
| [Rentmoola](https://rentmoola.com) | Vancouver, CA | Cloud (NA/UK) | Per-transaction | Rent-as-credit-card-tx | **0** — NA/UK consumer payments |
| [Klarna for rent (pilots)](https://www.klarna.com) | Stockholm, SE | Cloud (EU) | Tx fee | BNPL adapted to rent in select pilots | **0** — BNPL — not federal |
| [Tipalti](https://tipalti.com) | San Mateo, US | Cloud | Subscription + per-tx | AP automation; relevant for large landlords' supplier-pay | **2** — US AP automation |
| [GetMyInvoices](https://www.getmyinvoices.com) | Hannover, DE | Cloud (EU) | Per-user | Invoice retrieval + DATEV export | **2** — DE invoice retrieval |
| [Lexware](https://www.lexware.de) | Freiburg, DE (Haufe Group) | On-prem + cloud | Per-user | DE SME accounting | **2** — DE SME |
| [Sage 50 / Sage Business Cloud](https://www.sage.com) | Newcastle, UK | Cloud + on-prem | Per-user | Cross-DACH accounting | **2** — Cross-DACH |
| [Infoniqa (formerly Sage CH)](https://www.infoniqa.com) | Stans, CH | On-prem + cloud | Per-user | Swiss payroll-and-accounting | **2** — Swiss payroll niche |
...
| Product | HQ | Hosting | Pricing | Notable feature | BBL fit |
|---|---|---|---|---|---|
| [Archilogic](https://www.archilogic.com/) | Zurich, CH | Cloud (CH / EU) | Per building | **Swiss-domiciled** 3D floor plans + Floor Plan Engine + indoor-mapping API; widely embedded as the floor-plan layer inside IWMS and WEX products (adjacent to Segments A, B) | **9** — Swiss-domiciled; floor-plan API |
| [Steerpath](https://steerpath.com) | Helsinki, FI | Cloud | Per building | Powers Senaatti's Senate App (federal benchmark — Segment P) | **5** — FI federal-benchmark provider |
| [MapsIndoors](https://www.mapsindoors.com) | Copenhagen, DK | Cloud | Per building | Google Maps-style indoor mapping | **2** — DK indoor mapping |
| [Pointr](https://www.pointr.tech) | London, UK | Cloud | Per building | Indoor positioning + wayfinding | **2** — UK indoor positioning |
| [MazeMap](https://www.mazemap.com) | Trondheim, NO | Cloud | Per building | Nordic indoor mapping | **2** — NO indoor mapping |
| [IndoorAtlas](https://www.indooratlas.com) | Oulu, FI | Cloud | Per building | Magnetic-field indoor positioning | **2** — FI positioning |
| [MappedIn](https://www.mappedin.com) | Waterloo, CA | Cloud | Per building | Partners with ServiceNow WSD | **2** — CA; ServiceNow-bound |
| [Esri ArcGIS Indoors](https://www.esri.com) | Redlands, US | Cloud + on-prem | Per user | Enterprise indoor GIS | **5** — Enterprise indoor GIS |
...
| Product | HQ | Hosting | Pricing | Notable feature | BBL fit |
|---|---|---|---|---|---|
| [Locatee (Tango)](https://www.tangoanalytics.com) | Zurich, CH (Tango) | Cloud | Per building | **Swiss-domiciled engineering presence**; sensor-free Wi-Fi-based; acquired by Tango Analytics Mar 2024; Zurich is Tango's European HQ | **5** — CH engineering presence; workplace |
| [VergeSense](https://vergesense.com) | San Francisco, US | Cloud | Per sensor | Computer-vision occupancy sensors | **2** — US CV occupancy |
| [Density](https://www.density.io) | New York, US | Cloud | Per sensor | Depth-camera occupancy | **2** — US occupancy |
| [XY Sense](https://xysense.com) | Melbourne, AU | Cloud | Per sensor | AI-vision occupancy | **2** — AU occupancy |
| [Butlr](https://butlr.com) | San Francisco, US | Cloud | Per sensor | Thermal-vision occupancy | **2** — US thermal occupancy |
| [Disruptive Technologies](https://www.disruptive-technologies.com) | Oslo, NO | Cloud | Per sensor | Cellular IoT sensors (cross-listed in Segment L) | **2** — NO IoT sensors |
| [Akenza](https://akenza.io) | Zurich, CH | Cloud | Per device | **Swiss-domiciled IoT platform**; cross-listed in Segment L for sensor-platform overlap | **9** — Swiss-domiciled IoT platform |
| [enlighted (Siemens)](https://www.enlightedinc.com) | Sunnyvale, US (Siemens) | Cloud | Per fixture | Sensor-rich occupancy + lighting | **2** — US Siemens-bound |
| [Steelcase Workplace Advisor](https://www.steelcase.com) | Grand Rapids, US | Cloud | Per workspace | Furniture-vendor analytics overlay | **2** — Furniture-vendor overlay |
| [Microshare](https://www.microshare.io) | Philadelphia, US | Cloud | Per sensor | LoRaWAN-based occupancy | **2** — US LoRaWAN occupancy |
| [Spica Technologies](https://www.spicatech.co.uk) | UK | Cloud | Per building | Workplace-experience analytics | **2** — UK workplace analytics |
...
|---|---|---|---|---|---|---|
| [Autodesk Construction Cloud (BIM 360 / ACC)](https://construction.autodesk.com/) | San Francisco, USA | Cloud | Per user | Revit, Civil 3D, Navisworks, IFC | De-facto CDE standard; Revit-native | **5** — De-facto CDE; pre-occupancy |
| [Bentley iTwin / ProjectWise](https://www.bentley.com/software/itwin/) | Exton (PA), USA | Cloud / hybrid | Per asset / per user | OpenBuildings, IFC, MicroStation | Asset-twin handover into operations | **5** — BIM2FM handover relevant |
| [Revizto](https://revizto.com/) | Lausanne, CH | Cloud | Per user | Revit, Navisworks, IFC | **Swiss-domiciled** issue tracking & clash review | **9** — Swiss-domiciled (Lausanne); CH federal track |
| [Solibri](https://www.solibri.com/) | Helsinki, FI (Nemetschek) | Hybrid | Per user | IFC, Revit, ArchiCAD | Model checking / clash detection | **5** — FI Nemetschek; clash detection |
| [BIMcollab](https://www.bimcollab.com/) | Eindhoven, NL | Cloud | Per user | BCF, Revit, Navisworks | OpenBCF issue management | **5** — OpenBCF |
| [Procore](https://www.procore.com/) | Carpinteria (CA), USA | Cloud | Per user | Revit, Sage, Quickbooks | General-contractor PM | **2** — US GC PM |
| [Trimble Connect](https://www.connect.trimble.com/) | Westminster (CO), USA | Cloud | Per user | Tekla, SketchUp, IFC | CDE + viewer; KBOB-aligned workflows | **5** — KBOB-aligned CDE |
| [dRofus](https://www.drofus.com/) | Oslo, NO (Nemetschek) | Cloud | Per user | Revit, IFC, ArchiCAD | Room/equipment data management; track record in CH federal projects | **9** — CH federal-project track record |
| [PlanRadar](https://www.planradar.com/) | Vienna, AT | Cloud | Per user | BIM, IFC | Snagging/defect handover; also listed in Segment G | **9** — Widely used in CH (also Segment G) |
| [Buildots](https://www.buildots.com/) | London, UK | Cloud | Per user | BIM, computer vision | AI construction-progress vs. BIM model | **2** — UK CV |
| [Capmo](https://www.capmo.com/) | Munich, DE | Cloud | Per user | BIM, defect/snagging | DACH construction-PM SaaS | **5** — DACH construction PM |
| [Allplan](https://www.allplan.com) | Munich, DE (Nemetschek) | Cloud + on-prem | Per user | IFC, Revit | German-engineered BIM authoring | **5** — DE Nemetschek |
| [Graphisoft ArchiCAD](https://graphisoft.com) | Budapest, HU (Nemetschek) | Cloud + on-prem | Per user | IFC, BCF | BIM authoring | **2** — BIM authoring |
| [Vectorworks](https://www.vectorworks.net) | Columbia, US (Nemetschek) | Cloud + on-prem | Per user | IFC, DWG | BIM/CAD | **2** — BIM/CAD |
| [Catenda Hub](https://catenda.com) | Oslo, NO | Cloud | Per user | IFC native, BCF | openBIM CDE; IFC-native | **5** — openBIM CDE |
| [Plannerly](https://plannerly.com) | US / UK | Cloud | Per user | IFC, Revit | BIM execution planning | **2** — BIM planning |
| [Speckle](https://speckle.systems) | London, UK | Cloud + self-host | Open-source | Multi-CAD | Open-source BIM interoperability / data hub | **9** — OSS BIM; EMBAG-aligned |
| [BIMobject](https://www.bimobject.com) | Malmö, SE | Cloud | Free + subscription | IFC, Revit | Product library | **2** — product library |
| [BIM&CO](https://www.bimandco.com) | Bordeaux, FR | Cloud | Subscription | IFC | Product library | **2** — product library |
| [BIM Track / Newforma Konekt](https://newforma.com) | Quebec, CA / Manchester NH, US | Cloud | Per user | BCF | Issue management; merged into Newforma | **2** — issue mgmt |
| [DesignBuilder](https://designbuilder.co.uk) | Stroud, UK | Desktop | Per user | IFC | IFC-driven simulation | **2** — IFC simulation |
...
| Product | HQ | Notable feature | BBL fit |
|---|---|---|---|
| [Leverton (MRI Software)](https://www.mrisoftware.com/) | Berlin, DE (MRI) | Acquired by MRI 2020; AI lease abstraction for IFRS 16 / FASB / RE-FX | **5** — SAP RE-FX abstraction; post-SUPERB cleanup |
| [Prophia](https://www.prophia.com/) | San Francisco, USA | Lease intelligence for commercial RE | **2** — US commercial RE |
| [contract.fit](https://contract.fit/) | Brussels, BE | AI document extraction; contract abstraction | **5** — EU AI extraction |
| [Hyperscience](https://www.hyperscience.com/) | New York, USA | General-purpose AI document processing | **2** — US AI doc |
| [Rossum](https://rossum.ai/) | Prague, CZ | AI document understanding; broader than leases | **5** — CZ AI doc understanding |
| [LeaseHawk](https://www.leasehawk.com/) | Scottsdale (AZ), USA | AI leasing assistant (multifamily) | **2** — US multifamily |
| [docunite](https://docunite.com/) | Berlin, DE | DACH AI document processing for real estate | **5** — DACH AI doc |
...
| Product | HQ | Notable feature | BBL fit |
|---|---|---|---|
| [pit-FM (pit – cup)](https://www.pit.de/) | Heidelberg, DE | GEFMA-certified; long-standing DACH leader | **5** — GEFMA-certified DACH leader |
| [waveware (Loy & Hutz)](https://www.loy-hutz.de/) | Burgdorf, DE | GEFMA-certified; broad CAFM suite | **5** — GEFMA-certified |
| [ConjectFM (RIB Software)](https://www.rib-software.com/) | Stuttgart, DE (RIB Group) | CAFM + BIM2FM bridge | **5** — RIB Group CAFM |
| [FAMOS (Keßler Solutions)](https://www.kesslersolutions.de/) | Chemnitz, DE | DACH CAFM; popular in the mid-tier | **5** — DACH mid-tier |
| [KEYLOGIC](https://www.keylogic.ch/) | Bern, CH | **Swiss-domiciled** CAFM; KBOB-aligned; cantonal RE deployments — ⚠️ `keylogic.ch` served a parked Hetzner page during the 18 May 2026 scan, verify vendor status | **9** — Swiss-domiciled CAFM (verify status) |
| [Speedikon FM](https://www.speedikon.com/) | Bensheim, DE | CAFM + ERP integration | **5** — DE CAFM + ERP |
| [GEORG (VIT)](https://www.vit-group.de/) | Hannover, DE | GIS-led CAFM for industrial / federal estates | **5** — DE federal-estate GIS-CAFM |
| [TOL (Total Office Solutions)](https://tol.ch) | Lausanne, CH | **Swiss-domiciled** FM / workplace | **9** — Swiss-domiciled FM |
| [Caverion CAFM](https://www.caverion.com) | Helsinki, FI | FM-integrator with bundled CAFM analytics; cross-listed in Segment AG | **5** — FI FM integrator |
...
| Product | HQ | Notable feature | BBL fit |
|---|---|---|---|
| [Deepki](https://www.deepki.com/) | Paris, FR | Portfolio ESG SaaS; native CRREM / GRESB integration | **5** — FR portfolio ESG; CRREM-native |
| [Measurabl](https://www.measurabl.com/) | San Diego, USA | GRESB-aligned; market share leader in public real estate | **5** — GRESB leader |
| [Optera](https://www.opteraclimate.com/) | Boulder (CO), USA | Scope 1/2/3 + supplier engagement | **2** — US Scope 1-3 |
| [Carbonsight](https://www.carbonsight.de/) | Berlin, DE | DACH ESG SaaS for real estate | **5** — DACH ESG SaaS |
| [ENGIE Impact](https://www.engieimpact.com/) | New York, USA | ENGIE-group sustainability consulting + data | **5** — ENGIE consultancy + data |
| [Spacewell Energy (Dexma)](https://spacewell.com/) | Barcelona, ES (Nemetschek) | AI energy management; also listed in N | **5** — EU energy AI |
| [Sustain.life](https://www.sustain.life/) | New York, USA | Mid-market sustainability platform | **2** — US mid-market |
| [Schneider Resource Advisor](https://www.se.com/) | Rueil-Malmaison, FR | Energy + sustainability for enterprise portfolios | **5** — FR enterprise |
| [Sweep](https://www.sweep.net/) | Paris, FR | Climate-data platform with RE module | **5** — FR climate |
| [BuildingMinds](https://buildingminds.com/) | Berlin, DE (Schindler family-backed) | Real-estate data platform; CRREM, EU Taxonomy and EPBD modules; **cross-listed in Segment L** for digital-twin capabilities | **5** — DE Schindler-backed; twin + ESG |
| [Sphera](https://sphera.com) | Chicago, US | EHS + ESG platform | **2** — US EHS |
| [Spheria](https://spheria.com) | Paris, FR | ESG data-platform | **2** — FR ESG |
| [Persefoni](https://persefoni.com) | Tempe, US | Carbon accounting | **2** — US carbon |
| [Watershed](https://watershed.com) | San Francisco, US | Enterprise carbon | **2** — US enterprise |
| [Climatiq](https://www.climatiq.io) | Berlin, DE | Carbon-data API | **2** — DE carbon API |
| [Greenly](https://greenly.earth) | Paris, FR | SME-friendly carbon | **2** — FR SME |
| [Plan A](https://plana.earth) | Berlin, DE | Enterprise carbon-accounting + decarbonisation | **2** — DE enterprise |
| [GRESB](https://www.gresb.com) | Amsterdam, NL | Real-estate ESG benchmark | **5** — Benchmark org, not vendor |
...
| Project | License | Origin | Relevance | BBL fit |
|---|---|---|---|---|
| [Odoo (Property modules)](https://www.odoo.com/) | LGPLv3 + commercial | Belgium | ERP with community + enterprise property-management modules | **5** — OSS ERP — EMBAG-aligned |
| [ERPNext (Real Estate module)](https://erpnext.com/) | GPL v3 | India (Frappe Technologies) | Community-maintained real-estate module within Frappe ERP | **5** — OSS ERP — community-maintained |
| [Tryton (rental modules)](https://www.tryton.org/) | GPL v3 | Belgium | Modular ERP with rental/property extensions | **5** — OSS ERP — modular |
| [Keycloak](https://www.keycloak.org/) | Apache 2.0 | Red Hat (community) | OSS IdP; AGOV-federation broker alternative; SAML/OIDC native | **9** — OSS IdP; AGOV broker option; EMBAG-aligned |
| [Zammad](https://zammad.org/) | AGPL v3 | Germany | OSS service desk; honest OSS analogue to Segment G repair-ticketing front-ends | **9** — OSS service desk; EMBAG-aligned |
| [Mattermost](https://mattermost.com/) | MIT | USA (community) | OSS team collaboration; civic-tech projects use it for tenant-staff comms | **9** — OSS team comms; EMBAG-aligned |
| [GeoNode](https://geonode.org/) | GPL v3 | USA (OSGeo) | OSS geospatial publishing; complements BBL GIS IMMO (Appendix A) | **5** — OSS GIS; complements BBL GIS IMMO |
| [BIMserver](https://bimserver.org/) | AGPL v3 | TU Eindhoven | OSS BIM model server; complements CDE-Bund stack (Segment W) | **5** — OSS BIM server |
| [civic-tech.ch / opendata.swiss tooling](https://civictech.ch/) | various | Switzerland | Swiss civic-tech community; federal-relevant tools surface periodically | **9** — Swiss civic-tech community |
| [Hugging Face open document-AI](https://huggingface.co/models) | various | France/USA | OSS OCR + LLM models; honest alternative to Segment X commercial lease abstraction | **9** — OSS doc-AI; EMBAG-aligned |
| [Plone](https://plone.org) | BSD-like | global community | CMS in CH/AT/DE federal use; security-hardened | **9** — Federal-CH CMS reference |
| [Drupal](https://www.drupal.org) | GPL v2 | global community | Used in Swiss federal websites and many DACH cantons / cities | **9** — Swiss federal-website CMS |
| [TYPO3](https://typo3.org) | GPL v2 | Düsseldorf-based association | Dominant in DACH public-sector CMS | **9** — DACH public-sector CMS |
| [Strapi](https://strapi.io) | MIT + Enterprise | Paris, FR | Open-source headless CMS | **5** — OSS headless CMS |
| [Directus](https://directus.io) | BSL → MIT | Brooklyn, US | Headless CMS / data platform | **5** — OSS headless / data platform |
...
| Product | HQ | License | Notable feature | BBL fit |
|---|---|---|---|---|
| [Microsoft Power Automate](https://www.microsoft.com/en-us/power-platform/products/power-automate) | Redmond, USA | Commercial (M365 / Power Platform) | M365-native; deep Outlook / Teams / SharePoint hooks; **Azure Switzerland regions** available | **9** — M365-native; Azure CH; low adoption friction |
| [Microsoft Power Apps](https://www.microsoft.com/en-us/power-platform/products/power-apps) | Redmond, USA | Commercial (M365 / Power Platform) | Low-code app builder; pairs with Power Automate for form + flow + UI | **9** — M365-native low-code |
| [SAP Build Process Automation](https://www.sap.com/products/technology-platform/process-automation.html) | Walldorf, DE | Commercial (BTP) | Successor to SAP Workflow Management; native to SAP BTP; aligned with the custom-Fiori-on-BTP pattern in Segment Q | **9** — BTP-native; aligns with Create variant |
| [SAP Build Apps / SAP Build Work Zone](https://www.sap.com/products/technology-platform/build.html) | Walldorf, DE | Commercial (BTP) | Low-code app builder + work-zone (portal shell) on BTP | **9** — BTP-native portal shell + low-code |
| [n8n](https://n8n.io/) | Berlin, DE | Fair-code (sustainable-use license); self-hostable | OSS-friendly; deep integrations including SAP, M365, Slack, Telegram; **EMBAG-aligned automation alternative** when self-hosted in CH | **9** — Fair-code, self-hostable, EMBAG-aligned |
| [Camunda](https://camunda.com/) | Berlin, DE | Commercial + Community Edition (Apache 2.0) | BPMN 2.0 / DMN 1.3 standards; deep federal/government track record (DE BAMF, BKA, BImA; NL DUO, BZ) | **9** — BPMN standard; DE federal track |
| [Activepieces](https://www.activepieces.com/) | Toronto, CA | MIT + commercial cloud | Fully open-source Zapier alternative; self-hostable | **9** — Fully OSS; EMBAG-aligned |
| [Make (ex-Integromat)](https://www.make.com/) | Prague, CZ | Commercial | Visual workflow automation; EU-hosted; very strong free tier for prototyping | **5** — EU visual workflow |
| [Zapier](https://zapier.com/) | San Francisco, USA | Commercial | Largest SaaS automation marketplace (~7,000 integrations); US-hosted | **2** — US automation |
| [Bonita / Bonitasoft](https://www.bonitasoft.com/) | Grenoble, FR | Open-source Community + commercial | BPMN engine; FR public-sector deployments (CNAM, DGFiP); OSS-by-default friendly | **5** — FR public-sector BPMN |
| [ProcessMaker](https://www.processmaker.com/) | Durham (NC), USA | Open-source Community + commercial | BPMN; intelligent document processing; multilingual | **5** — OSS+commercial BPMN |
| [Pega Platform](https://www.pega.com/) | Cambridge (MA), USA | Commercial | Enterprise BPM + AI-decisioning; deep insurance / public-sector heritage | **2** — US enterprise BPM |
| [Appian](https://appian.com/) | McLean (VA), USA | Commercial | Enterprise low-code / BPM; FedRAMP-authorized in US federal | **2** — US FedRAMP |
| [OutSystems](https://www.outsystems.com/) | Linda-a-Velha, PT | Commercial | Enterprise low-code; long-running EU public-sector deployments | **5** — PT EU public-sector low-code |
| [Mendix (Siemens)](https://www.mendix.com/) | Boston, USA (Siemens) | Commercial | Siemens-owned low-code; natural pair to Siemens Building X / Cobundu adjacencies (Segment L) | **5** — Siemens-bound low-code |
| [ServiceNow Flow Designer](https://www.servicenow.com/) | Santa Clara, USA | Commercial | Native to ServiceNow; bundled with WSD (Segment A/B) and Nuvolo CWP | **2** — ServiceNow-bound |
| [Microsoft Logic Apps](https://azure.microsoft.com/en-us/products/logic-apps) | Redmond, US | Commercial (Azure) | iPaaS within Azure | **5** — Azure-bound iPaaS |
| [Tray.io](https://tray.io) | San Francisco, US | Commercial | iPaaS | **2** — US iPaaS |
| [Workato](https://www.workato.com) | Mountain View, US | Commercial | Enterprise iPaaS | **5** — Enterprise iPaaS |
| [Pipefy](https://www.pipefy.com) | San Francisco, US | Commercial | BPM no-code | **2** — US BPM |
| [Kissflow](https://kissflow.com) | Chennai, IN | Commercial | BPM no-code | **2** — IN BPM |
| [Flowable](https://www.flowable.com) | Zurich, CH (with NL roots) | Open-source + commercial | **Swiss-domiciled open-source BPMN engine** — direct relevance to federal CH workflows | **9** — Swiss-domiciled OSS BPMN — direct fit |
| [Trisotech](https://www.trisotech.com) | Quebec, CA | Commercial | BPMN / CMMN / DMN authoring | **2** — CA BPMN authoring |
| [Decisions](https://decisions.com) | Chesapeake, US | Commercial | Process automation | **2** — US BPM |
| [Twigg](https://twigg.io) | UK | Commercial | Workflow automation | **2** — UK workflow |
...
| Product | HQ | Hosting | Pricing | Notable feature | BBL fit |
|---|---|---|---|---|---|
| [CRIF AG](https://www.crif.ch) | Zurich, CH (parent Bologna, IT) | Cloud (CH region) | B2B API per-query; free self-disclosure once a year | National creditworthiness DB; CRIF score 1–600; co-issuer of CreditTrust | **9** — CH Bonität bureau; widely accepted |
| [Intrum AG](https://www.intrum.ch) | Schwerzenbach, CH (parent Stockholm, SE) | Cloud (CH/EEA) | B2B API per-query; free self-disclosure once a year | National creditworthiness DB; co-issuer of CreditTrust | **9** — CH Bonität bureau |
| [CreditTrust](https://credittrust.ch) | Zurich, CH (JV of CRIF + Intrum, 2018) | Cloud (CH) + Ethereum-anchored hash | Free for accepting businesses; ~CHF 25 to applicant | Blockchain-anchored Bonitätszertifikat; aggregates both major Swiss bureaus; embedded into homegate.ch / ImmoScout24.ch flow per SMG Real Estate | **9** — Swiss JV; standard digital rental Bonität |
| [Creditreform Schweiz](https://www.creditreform.ch) | St. Gallen, CH | Cloud | B2B subscription / per-query | DACH-wide commercial credit; cantonal coverage | **5** — DACH commercial Bonität |
| [moneyhouse.ch](https://www.moneyhouse.ch) | Zurich, CH (Ringier) | Cloud (CH) | Freemium; Premium ~CHF 7/month | Trade-register + Bonität aggregator; popular tenant background check | **5** — CH aggregator |
| [SCHUFA Holding](https://www.schufa.de) | Wiesbaden, DE (founded 1927) | Cloud (DE) | B2B per-query; consumer Bonitätscheck ~€29.95 | Dominant DE consumer bureau; "SCHUFA-BonitätsAuskunft" is the de-facto German rental document | **2** — DE consumer bureau |
| [KSV1870](https://www.ksv.at) | Vienna, AT | Cloud (AT) | B2B subscription | Dominant AT bureau | **2** — AT bureau |
| [Bisnode D&B Switzerland](https://www.bisnode.ch) | Urdorf, CH (Dun & Bradstreet) | Cloud | B2B subscription | Commercial Bonität; D&B D-U-N-S | **5** — CH commercial Bonität |
| [Acrevis CreditCheck / Onlineprüfung](https://www.acrevis.ch) | St. Gallen, CH | Cloud | Per-check | Bank-grade Bonitätscheck used by some Swiss agencies | **5** — CH bank-grade |
| [PXL Vision](https://www.pxl-vision.com) | Zurich, CH (Mühlebachstrasse 164, 8008; founded 2017 as Dacuda spin-off) | SaaS + on-prem | Quote-based; volume tiers | Swiss-made browser-based AutoID in <30 s; ISO 27001; ZertES + eIDAS-compliant via Swisscom Trust | **9** — Swiss IDV; ZertES + eIDAS |
| [KYC Spider](https://www.kyc-spider.com) | Aarau, CH | Cloud (CH) | Per-check / subscription | Swiss-domiciled AML/KYC tooling | **9** — Swiss-domiciled KYC |
| [IDnow](https://idnow.io) | Munich, DE (founded 2014) | Cloud (DE/EU) | Per-verification; quote | BaFin-anerkannt VideoIdent + AutoIdent; EUDI Wallet ready | **5** — DE BaFin VideoIdent |
| [WebID Solutions](https://www.webid-solutions.de) | Berlin / Solingen, DE | Cloud (DE) | Per-verification | First BaFin-licensed VideoIdent (2014); QES-capable | **5** — DE BaFin VideoIdent |
| [Onfido (Entrust Identity Verification)](https://onfido.com) | London, UK — acquired by Entrust April 2024 | Cloud (EU/UK residency available) | Quote-based; volume tiers; per-Finexer's industry data, median annual spend ~$60,475, range $6,156–$945,900 | "Atlas AI" liveness + ~2,500 documents; data-processor by default per April 2025 Product Privacy Notice | **2** — UK/global IDV |
| [Veriff](https://www.veriff.com) | Tallinn, EE | Cloud | Self-serve tiers + Enterprise quote | Supports 12,500+ identity documents across 230+ countries (Veriff marketing, Sept 2025) | **2** — EE IDV |
| [Sumsub](https://sumsub.com) | London, UK / Berlin DE office | Cloud | Per-successful-verification | All-in-one KYC/AML/KYB + fraud | **2** — UK KYC/AML |
| [Klippa](https://www.klippa.com) | Groningen, NL | Cloud (EU) | Per-document / subscription | OCR + IDV for property and finance | **2** — NL OCR + IDV |
| [Goodlord](https://www.goodlord.co) | London, UK | Cloud | Per-tenancy fee | UK letting platform with embedded referencing | **2** — UK letting |
| [HomeLet](https://homelet.co.uk) | Lincoln, UK (Barbon Insurance Group) | Cloud | Per-reference | Largest UK tenant-referencing volume | **2** — UK referencing |
| [Canopy](https://www.canopy.rent) | London, UK | Cloud | Free for tenants; lettings-agent subs | "RentPassport" — Open-Banking-based rent-affordability + Experian-fed score | **2** — UK rent-passport |
| [Experian RentBureau](https://www.experian.com/rentbureau) | Costa Mesa, US (Dublin EMEA HQ) | Cloud | Per-record | US rent payment reporting; feeds FICO 9/10 | **0** — US rent reporting |
| [RentSpree](https://www.rentspree.com) | Los Angeles, US | Cloud (US) | Per-application $39.99 | US tenant screening incl. TransUnion data | **0** — US tenant screening |
| [TransUnion SmartMove](https://www.mysmartmove.com) | Chicago, US | Cloud (US) | Per-screening $25–$40 | US tenant screening | **0** — US tenant screening |
| [Naborly](https://naborly.com) | Toronto, CA | Cloud | Per-application | AI-based tenant scoring, CA/US focus | **0** — NA AI tenant scoring |
...
| Product | HQ | Hosting | Pricing | Notable feature | BBL fit |
|---|---|---|---|---|---|
| [SwissCaution](https://www.swisscaution.ch) | Bussigny / Lausanne, CH (La Mobilière subsidiary) | Cloud | 5 % of guarantee p.a. + CHF 20 admin + 5 % stamp duty | "No. 1 most widely accepted" rental guarantee CH; Post-branch distribution since 2009; loyalty programme up to 30 % discount | **9** — CH #1 rental guarantee |
| [Firstcaution](https://www.firstcaution.ch) | Nyon, CH (Zurich + Bellinzona offices; family-owned, 65 staff) | Cloud | Monthly or annual premium; flexible deposit hybrid | FINMA-approved; only CH provider offering true monthly billing; >100,000 customers | **9** — CH FINMA-approved |
| [goCaution](https://www.gocaution.ch) | Zurich, CH (Generali subsidiary) | Cloud | Annual premium | Generali-backed | **9** — CH FINMA-approved |
| [SmartCaution](https://www.smartcaution.ch) | CH | Cloud | Annual premium | Niche CH provider | **5** — CH niche |
| [Helvetia Kautionsversicherung](https://www.helvetia.com/ch) | St. Gallen, CH | Cloud | Annual premium | Traditional insurer arm | **9** — CH traditional insurer |
| [AXA Mietkaution](https://www.axa.ch) | Winterthur, CH | Cloud | Annual premium | Direct insurer offering | **9** — CH direct insurer |
| [Zurich Kautionsversicherung](https://www.zurich.ch) | Zurich, CH | Cloud | Annual premium | Direct insurer offering | **9** — CH direct insurer |
| [Eurokaution (EuroKaution Service EKS)](https://www.eurokaution.de) | Baden-Baden, DE (founded 2008) | Cloud (DE) | 4.7 % of deposit p.a., min. €50/yr | "Deutschlands ältester Mietkautionsgesellschaft seit 2008"; bond issued by R+V Versicherung | **2** — DE rental guarantee |
| [Deutsche Kautionskasse AG (Moneyfix®)](https://www.kautionskasse.de) | Starnberg, DE (founded 2008) | Cloud (DE) | ~4.7 % p.a. (Assekuradeur model) | Bürgschaftsurkunde issued by Allianz (private) / ERGO (gewerbe) | **2** — DE rental guarantee |
| [plusForta GmbH](https://plusforta.de) — operating kautionsfrei.de, heysafe.de, kautionsfuchs.de | Düsseldorf, DE (Talstraße 24) | Cloud (DE) | ~4.99 % p.a. (private) | Multi-brand operator; **Aareal Bank Group-owned since Feb 2019** — direct corporate-family link to PM-software giant Aareon | **5** — DE; Aareal Group-owned |
| [Cosmos Direkt Mietkaution](https://www.cosmosdirekt.de) | Saarbrücken, DE (Generali) | Cloud | ~5.2 % p.a. | Direct insurer | **2** — DE direct insurer |
| [Flatfair](https://www.flatfair.co.uk) | London, UK (founded 2016) | Cloud (UK) | Non-refundable check-in fee = 28 % of one month's rent + VAT, min £120 | "Deposit-free renting"; 850+ agents & BTR operators; Index Ventures-backed | **2** — UK deposit-free |
| [Reposit](https://reposit.co.uk) | London, UK (128 City Road; founded 2015) | Cloud | ~1 week's rent + VAT | 8 weeks' protection | **2** — UK deposit-replacement |
| [Zero Deposit](https://www.zerodeposit.com) | UK | Cloud | 1 week's rent + £59.99 set-up + £17.50/yr | **Underwritten by Aviva; FCA-regulated; TDS-adjudicated**; works with 79 % of top UK estate agents that have chosen a deposit-replacement option (per ZeroDeposit.com) | **2** — UK deposit-replacement |
| [Insurami](https://insurami.com) | London, UK | Cloud | Commission-based | Commercial-lease deposit substitution | **2** — UK commercial lease |
| [Getsafe](https://www.hellogetsafe.com/de-de) | Heidelberg, DE (founded 2015) | Cloud (DE) | Monthly micro-pricing in-app | App-native insurtech; Hausrat + Haftpflicht + Rechtsschutz; **over 500,000 customers in Germany, Austria and France**, supported by more than €120 m in venture capital from Earlybird, CommerzVentures, Swiss Re (Getsafe press release 2025) | **2** — DE insurtech consumer |
| [Friday → Allianz Direct](https://www.friday.de) | Berlin, DE (founded 2017) | Cloud | Monthly Kfz/Hausrat | **Allianz Direct announced acquisition of Friday's portfolio from Baloise in Oct 2024; Friday brand being wound down (Handelsblatt, Oct 2024)** | **2** — DE — brand winding down |
| [Adam Riese](https://www.adam-riese.de) | Stuttgart, DE (Württembergische / W&W Group) | Cloud | Monthly Hausrat/Haftpflicht | Digital brand of W&W | **2** — DE digital insurer |
| [Canopy Rent Insurance](https://www.canopy.rent) | London, UK | Cloud | Per-tenancy | Rent guarantee + contents bundle | **2** — UK rent guarantee |
...
| Product | HQ | Hosting | Pricing | Notable feature | BBL fit |
|---|---|---|---|---|---|
| [POLYAS](https://www.polyas.com) | Kassel / Berlin, DE (first online election 1996) | Cloud (DE) | Per-election; quote | BSI Common Criteria-certified core (POLYAS CORE 2.5.0, recertified June 2025); customers incl. CDU party convention, EBRD, Diocese of Freiburg | **5** — DE BSI-certified voting |
| [vote.io](https://vote.io) | DE | Cloud (DE) | Per-event | WEG/Vereins-focused live voting | **5** — DE WEG voting |
| [OASIS Voting](https://www.oasis-voting.com) | DE/EU | Cloud (DE) | Per-event | Hybrid Versammlung | **2** — DE hybrid Versammlung |
| [Vote@Home](https://www.vote-at-home.de) | DE | Cloud (DE, GDPR) | Per-event | Open-source-based; integrated Jitsi for video; weighted/named/secret votes; proxy & Weisung management aimed at WEG-Verwalter | **5** — OSS-based DE WEG voting |
| [casavi WEG-Versammlung module](https://casavi.com/en) | Munich, DE (Aareon-owned since 2022) | Cloud | Add-on to casavi suite | WEG hybrid/online meetings; integration with Win-CASA, iX-Haus, DOMUS | **5** — Aareon ecosystem WEG |
| [etg24](https://www.etg24.de) | DE | Cloud (DE) | Subscription per unit | WEG portal incl. proxies, circular resolutions, hybrid Versammlung; on Aareon Marketplace | **2** — DE WEG portal |
| [iDWELL](https://www.idwell.com) | Vienna, AT | Cloud (EU) | Per-unit subscription | Mieter/Eigentümer-CRM + Versammlung; Win-CASA integration; idwell finance for invoice automation | **5** — AT CRM + Versammlung |
| [Civey](https://civey.com) | Berlin, DE | Cloud (DE) | Subscription | Opinion polling — not BSI-certified for legal Versammlungen, useful for non-binding tenant consultations | **2** — DE opinion polling |
| [ImmoSocial](https://www.immosocial.com) | DE | Cloud | Quote | Resident social platform | **2** — DE social |
| [Wohnglück](https://www.wohnglueck.de) | DE | Cloud | Subscription | Resident communication | **2** — DE comms |
| [Quartier Schweiz](https://www.quartier-schweiz.ch) | CH | Cloud (CH) | Subscription | Swiss neighbourhood/Quartier platform | **9** — Swiss neighbourhood platform |
| [Building Engines (JLL Technologies)](https://www.buildingengines.com) | Boston, US | Cloud | Quote | US commercial-property tenant experience incl. voting | **2** — US commercial |
| [HOA Express](https://hoa-express.com) | US | Cloud | Per-HOA | US HOA / condo board management | **0** — US HOA |
| [AppFolio voting](https://www.appfolio.com) | Goleta, US | Cloud | Bundled with PM Plus | US residential PM with community voting | **2** — US PM voting |
| [RentCafe Resident Services](https://www.rentcafe.com) | Yardi | Cloud | Bundled with Voyager | US Yardi tenant portal incl. event/vote modules | **2** — US Yardi |
...
| Product | HQ | Hosting | Pricing | Notable feature | BBL fit |
|---|---|---|---|---|---|
| [Swisscharge / Energie 360° / GOFAST / Move](https://swisscharge.ch) | Zurich, CH (Energie 360° group) | Cloud (CH/EU) | App-free pay-as-you-charge; CHF ~0.59/kWh fast-charge typical | **Largest CH network: over 24,000 charging points and 250,000 users post-Move acquisition (July 2025); zero roaming inside group from 1 Nov 2025; CHF 200 m investment programme to 2030** | **9** — Largest CH network |
| [evpass (Shell Recharge Solutions)](https://www.evpass.ch) | CH (now Shell Recharge Solutions; former Groupe E) | Cloud | Up to ~CHF 0.79/kWh public fast-charging — ~CHF 46 for 50 kWh per TCS data cited by Carify, Mar 2026 | One of densest CH public networks; under Shell brand | **9** — Dense CH network |
| [Juice Technology AG](https://juice-world.com) | Cham, CH | Cloud + hardware | Hardware + Juice World portal subscription | Swiss-made Juice Booster mobile charger; integrated Juice World OCPP portal | **9** — Swiss-made charging hardware |
| [Park-it](https://park-it.ch) | Zug, CH | Cloud (CH) | Per-space subscription | CH parking-management with EV-charging integration | **9** — Swiss parking + EV |
| [chargecloud GmbH](https://www.chargecloud.com/en) | Cologne, DE | Cloud (DE) | Subscription per charge point + transaction fee | Modular CPO OS; white-label frontends; AI energy-management partner marketplace | **5** — DE CPO OS |
| [reev](https://reev.com) | Munich, DE | Cloud (DE) | Subscription per wallbox | Specialises in commercial fleet + multi-tenant residential | **5** — DE fleet / residential |
| [has·to·be → ChargePoint Europe](https://www.chargepoint.com) | Vienna / Klagenfurt, AT — **acquired by ChargePoint for ~$295 m in 2021** | Cloud | Subscription per CP | be.ENERGISED platform; AT/DE flagship CPO software; consolidated into ChargePoint Platform | **5** — AT/DE CPO software |
| [ChargePoint Platform](https://www.chargepoint.com) | Campbell, US (NYSE: CHPT) | Cloud (regional EU residency) | Subscription | Per ChargePoint press release of 11 Feb 2026: gives EV drivers access to **more than 900,000 roaming ports** in addition to **approximately 375,000 public and private ports that ChargePoint directly manages** (~1.275 M total); AI optimisation engine launched 13 Nov 2025 | **5** — US global CPO |
| [eMabler](https://www.emabler.com) | Helsinki, FI | Cloud (EU) | API-first per-CP | Headless CPO API | **2** — FI headless CPO |
| [GP JOULE Connect](https://www.gp-joule.com) | Reußenköge, DE | Cloud | Subscription + per kWh | German vertically-integrated CPO | **2** — DE CPO |
| [&Charge](https://www.andcharge.com) | Munich, DE (Mer Group) | Cloud | App; cashback model | Consumer-side rewards | **2** — DE consumer rewards |
| [ENGIE Vianeo](https://www.vianeo.com) | Paris, FR | Cloud | Per-session / subscription | ENGIE's CPO arm | **2** — FR CPO |
| [Allego](https://www.allego.eu) | Arnhem, NL | Cloud | Per-session | Pan-EU CPO; listed | **2** — NL pan-EU CPO |
| [Mer (Statkraft)](https://uk.mer.eco) | Oslo, NO | Cloud | Per-session | Statkraft-owned CPO | **2** — NO CPO |
| [EVgo](https://www.evgo.com) | Los Angeles, US | Cloud (US) | Per-session | US fast-charging | **0** — US fast-charging |
| [Wallbox](https://wallbox.com) | Barcelona, ES (NYSE: WBX) | Cloud | Hardware + myWallbox app subscription | Pulsar/Quasar bi-directional | **2** — ES hardware |
| [Pod Point](https://pod-point.com) | London, UK (EDF) | Cloud (UK) | Subscription | UK home + workplace | **2** — UK home + workplace |
| [Driivz (Vontier)](https://driivz.com) | Kfar Saba, IL | Cloud | Subscription | Enterprise CPO OS | **2** — IL enterprise CPO |
| [GreenFlux (DKV Mobility)](https://www.greenflux.com) | Amsterdam, NL | Cloud (EU) | Per-CP / per-transaction | Roaming-heavy CPO | **2** — NL roaming-heavy |
| [Parquery](https://parquery.com) | Zurich, CH (ETH spin-off) | Cloud (CH) | Per-camera subscription | Computer-vision parking occupancy | **9** — Swiss ETH spin-off; CV parking |
| [ParkingPay](https://www.parkingpay.ch) | Mendrisio, CH | Cloud (CH) | Per-transaction | Swiss municipal parking-payment app | **9** — Swiss municipal parking |
...
| Product | HQ | Hosting | Pricing | Notable feature | BBL fit |
|---|---|---|---|---|---|
| [Sauter Building Control (Sauter moduWeb / Vision)](https://www.sauter-controls.com) | Basel, CH | On-prem + edge + cloud | Project-based licence | Swiss-domiciled BACnet/IP, KNX, Modbus; SIA-aligned; cantonal/federal GA-Leitsystem reference | **9** — Swiss-domiciled; SIA-aligned; cantonal/federal reference |
| [Saia-Burgess Controls (SBC) / Saia PCD](https://www.saia-pcd.com) | Murten, CH — **Honeywell subsidiary since January 2013, acquired for $130 m from Johnson Electric** | On-prem PLC + Saia PCD Supervisor cloud | Hardware + licence | Saia PCD3 to ~10,000 I/O distributed; BACnet, LON, MS/TP; widely deployed in CH infrastructure/transport (SBB, VBZ) | **9** — Swiss-domiciled (Murten); CH infrastructure track |
| [Belimo Cloud](https://www.belimo.com) | Hinwil, CH | Hardware + cloud (BelimoCloud) | Hardware + connectivity sub | Valves & actuators with Energy-Valve + cloud telemetry | **9** — Swiss-domiciled (Hinwil) |
| [Siemens Desigo CC](https://www.siemens.com) | Zug, CH (Smart Infrastructure HQ) / Munich, DE | On-prem + Building X (cloud) | Per-data-point licence | Dominant DACH BMS supervisor; OEM-agnostic via BACnet, OPC UA | **9** — Smart Infrastructure HQ in Zug; DACH BMS leader |
| [Honeywell EBI / Niagara Tridium](https://buildings.honeywell.com) | Atlanta, US (Tridium: Richmond, US) | On-prem + cloud | Per-supervisor | Niagara framework de-facto integration layer; SBC, Trend, Optimizer, CentraLine all Niagara-compatible | **5** — Niagara de-facto integration layer |
| [Schneider Electric EcoStruxure Building](https://www.se.com) | Rueil-Malmaison, FR | On-prem + EcoStruxure Cloud | Per-controller | Building Operation supervisor + SmartX controllers | **5** — FR EcoStruxure |
| [Beckhoff TwinCAT BACnet](https://www.beckhoff.com) | Verl, DE | On-prem (TwinCAT runtime) | Per-runtime | PC-based control; software PLC | **2** — DE PC PLC |
| [Wago I/O System / Building Management](https://www.wago.com) | Minden, DE | On-prem | Per-controller | Modular I/O; BACnet, KNX, LoRaWAN | **5** — DE modular I/O |
| [Kieback&Peter](https://www.kieback-peter.com) | Berlin, DE | On-prem + Neutrino-EM cloud | Per-project | DACH-strong GA-Spezialist; family-owned | **5** — DACH family-owned GA |
| [Caverion Building Performance](https://www.caverion.com) | Helsinki, FI | On-prem + cloud | FM-contract bundled | Nordic+DACH FM-integrator with proprietary BMS analytics | **5** — Nordic + DACH FM integrator |
| [Johnson Controls Metasys](https://www.johnsoncontrols.com) | Cork, IE / Milwaukee, US | On-prem + OpenBlue cloud | Per-controller | Largest installed BMS base globally | **2** — IE/US BMS |
| [Trane Tracer SC+](https://www.trane.com) | Davidson, US | On-prem + Trane Connect | Per-controller | HVAC OEM supervisor | **2** — US HVAC supervisor |
| [ABB Cylon](https://global.abb/group/en) | Dublin, IE (now ABB) | On-prem | Per-controller | BACnet supervisor | **2** — IE BACnet |
| [Distech Controls (Acuity Brands)](https://www.distech-controls.com) | Brossard, CA | On-prem + cloud | Per-controller | Niagara-based | **2** — CA Niagara |
| [Iconics (Mitsubishi Electric)](https://www.iconics.com) | Foxborough, US | On-prem + Genesis cloud | Per-tag | OPC UA-native SCADA/BMS | **2** — US SCADA/BMS |
